...
<html lang="en">
  ...
  <body>
    ...
    <div id="streams">
      <button id="srf1" class="channel-active">SRF1</button>
      <button id="srf3">SRF3</button>
      <button id="srfMusikwelle">SRF Musikwelle</button>
      <button id="srfVirus">SRF Virus</button>
      <button id="couleur3">Couleur 3</button>
    </div>
    <h2 id="streamtime"></h2>
    <script type="module" data-implementation>
      // Import the pillarbox library
      ...
      const urns = {
        ...
        'srf3': [
          'urn:srf:audio:dd0fa1ba-4ff6-4e1a-ab74-d7e49057d96f', 'urn:srf:video:972b2dbd-3958-43b7-8c15-e92f56c8d734'
        ],
        'srfMusikwelle': [
      ...
      streams.addEventListener('click', (e) => {
        ...
        document.querySelectorAll('#streams button').forEach(button => button.classList.toggle('channel-active', button.id === id));
...
//# sourceMappingURL=index-CwvPjIvh.js.map
