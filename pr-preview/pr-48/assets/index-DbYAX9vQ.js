    ...
    <script type="module" data-implementation>
      ...
      class Countdown extends ModalDialog {
        ...
        constructor(player, options) {
          ...
          this.on(player, ['loadstart', 'playerreset', 'dipose', 'error'], this.reset);
        }
        ...
        dispose() {
          this.reset();
          this.off(this.player(), ['loadstart', 'playerreset', 'dipose', 'error'], this.reset);
...
//# sourceMappingURL=index-DbYAX9vQ.js.map
