 ...
 */const tt=Oo(class extends zo{constructor(t){var n;if(super(t),t.type!==Uo.ATTRIBUTE||t.name!=="class"||((n=t.strings)==null?void 0:n.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(n=>t[n]).join(" ")+" "}update(t,[n]){var o,i;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in n)n[a]&&!((o=this.nt)!=null&&o.has(a))&&this.st.add(a);return this.render(n)}const e=t.element.classList;for(const a of this.st)a in n||(e.remove(a),this.st.delete(a));for(const a in n){const r=!!n[a];r===this.st.has(a)||(i=this.nt)!=null&&i.has(a)||(r?(e.add(a),this.st.add(a)):(e.remove(a),this.st.delete(a)))}return Bo}});var I,vt,fn,kt,bn,dn,pn,hn,un,gn;class wt extends P{constructor(){super();R(this,I);this.src="",s(this,I,vt).call(this)}render(){const e={spin:this.drmSettingsShown===!0,"spin-back":this.drmSettingsShown===!1};return d`
    ...
    `}updated(e){super.updated(e),e.has("drmSettingsShown")&&this.drmSettingsShown&&this.shadowRoot.querySelector(".drm-settings-container").classList.add("active")}}I=new WeakSet,vt=function(){this.drmSettings={vendor:"",certificateUri:"",licenseUri:""}},fn=function(){try{return new URL(this.src).searchParams.get("urn")??this.src}catch{return this.src}},kt=function(){var a;const e=(a=s(this,I,fn).call(this))==null?void 0:a.trim(),o=e.startsWith("urn:")?"srgssr/urn":void 0,i=y(this,I,dn);this.dispatchEvent(new CustomEvent("submit-media",{detail:{src:e,type:o,keySystems:i}}))},bn=function(e){this.src=e.target.value,e.key==="Enter"&&this.src&&s(this,I,kt).call(this)},dn=function(){var e;if((e=this.drmSettings)!=null&&e.vendor)return s(this,I,pn).call(this)},pn=function(){var i,a;const e=(i=this.drmSettings.certificateUri)==null?void 0:i.trim(),o=(a=this.drmSettings.licenseUri)==null?void 0:a.trim();return this.drmSettings.vendor==="com.apple.fps.1_0"?{[this.drmSettings.vendor]:{certificateUri:e,licenseUri:o}}:{[this.drmSettings.vendor]:o}},hn=function(e){e.target.classList.toggle("active",!e.target.classList.contains("fade-out-shrink")),e.target.classList.remove("fade-in-grow","fade-out-shrink")},un=function(){return{"fade-in-grow":this.drmSettingsShown===!0,"fade-out-shrink":this.drmSettingsShown===!1}},gn=function(){return d`
      <form class="drm-settings-container ${tt(s(this,I,un).call(this))}"
            aria-hidden="${!this.drmSettingsShown}"
            @reset="${s(this,I,vt)}"
            @animationend="${e=>s(this,I,hn).call(this,e)}">
        <h3>DRM Settings</h3>
