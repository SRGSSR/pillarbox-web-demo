var Do=Object.defineProperty;var Vt=t=>{throw TypeError(t)};var jo=(t,n,e)=>n in t?Do(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var x=(t,n,e)=>jo(t,typeof n!="symbol"?n+"":n,e),dt=(t,n,e)=>n.has(t)||Vt("Cannot "+e);var y=(t,n,e)=>(dt(t,n,"read from private field"),e?e.call(t):n.get(t)),R=(t,n,e)=>n.has(t)?Vt("Cannot add the same private member more than once"):n instanceof WeakSet?n.add(t):n.set(t,e),Q=(t,n,e,o)=>(dt(t,n,"write to private field"),o?o.call(t,e):n.set(t,e),e),s=(t,n,e)=>(dt(t,n,"access private method"),e);import{r as D,t as q,a as F,b as B,x as d,p as Pt,c as w,e as No,i as Oo,d as zo,T as Uo,f as tn,v as Dt,g as Bo,o as nn}from"./core-demo-header-component-1irpUQGc.js";const Ho="[part=container]{block-size:480px;aspect-ratio:var(--ratio-widescreen);padding:0;overflow:visible;background-color:var(--color-12)}[part=close-btn]{position:absolute;top:calc(var(--size-3) * -1);right:0;z-index:2;width:var(--size-7);height:var(--size-7);font-size:var(--size-4);text-align:center;background:var(--gray-6);border-radius:var(--radius-round)}";var ie,Te,on,rn;class gt extends D{constructor(){super();R(this,Te);R(this,ie);this.open=!1}updated(e){super.updated(e),e.has("open")&&(this.open?(y(this,ie).showModal(),y(this,ie).classList.toggle("slide-up-fade-in",!0)):y(this,ie).close())}firstUpdated(e){super.firstUpdated(e),Q(this,ie,this.shadowRoot.querySelector("dialog"))}render(){return d`
 ...
 */function Z(t,n,e){return t?n(t):e==null?void 0:e(t)}class yn extends D{render(){return d`
  ...
  `]);customElements.define("scroll-to-top-button",vn);const pt=t=>t.replace(/\s+/g,"-").toLowerCase();var ee,kn,ze,Et,xn,Rt;const Pe=class Pe{constructor(n){R(this,ee);this.stack=[],this.level=n}async initialize(n,e,o){if(!n||!e)return;const i=s(this,ee,xn).call(this,n),a=s(this,ee,Rt).call(this,this.level[i].nodes,e);await this.fetchNextState(i,a),await s(this,ee,kn).call(this,o)}async fetchNextState(n,e){const o=this.level[n];this.stack.push({level:this.level,sectionIndex:n,nodeIndex:e}),this.level=[await o.resolve(o.nodes[e])]}fetchPreviousState(n){this.level=this.stack[n].level,this.stack.splice(n)}isLeafSection(n){var e;return(e=this.level[n])==null?void 0:e.isLeaf()}retrieveNode(n,e){var o;return(o=this.level[n])==null?void 0:o.nodes[e]}get root(){var n;return((n=this.stack[0])==null?void 0:n.level)||this.level}get params(){var n;return s(n=Pe,ze,Et).call(n,this.stack)}paramsAt(n,e){var o;return s(o=Pe,ze,Et).call(o,[...this.stack,{level:this.level,sectionIndex:n,nodeIndex:e}])}};ee=new WeakSet,kn=async function(n){for(const e of(n==null?void 0:n.split(","))||[]){const o=s(this,ee,Rt).call(this,this.level[0].nodes,e);await this.fetchNextState(0,o)}},ze=new WeakSet,Et=function(n){if(n.length===0)return{};const e=n[0],o=e.level[e.sectionIndex],i=n.slice(1).map(r=>{const l=r.level[r.sectionIndex].nodes[r.nodeIndex];return l.id||l.urn}),a={section:pt(o.title),bu:o.nodes[e.nodeIndex].toLowerCase()};return i&&i.length&&(a.nodes=i.join(",")),a},xn=function(n){const e=pt(n).toLowerCase();return this.level.map(o=>pt(o.title).toLowerCase()).findIndex(o=>o===e)},Rt=function(n,e){const o=e.toLowerCase();return n.map(i=>(i.urn||i.id||i.toString()).toLowerCase()).findIndex(i=>i===o)},R(Pe,ze);let nt=Pe;class I{constructor({title:n,nodes:e,resolve:o=void 0,next:i=void 0}){this.title=n,this.nodes=e,this.resolve=o,this.next=i}isLeaf(){return!this.resolve}async fetchNext(n=void 0){if(!this.next)return;const e=await this.next(n);return this.next=e.next,this.nodes.push(...e.results),e.results}}const $e=t=>({nodes:t.results,next:t.next}),ri=[new I({title:"TV Topics",nodes:["RSI","RTR","RTS","SRF","SWI"],resolve:async t=>new I({title:`${t} TV Topics`,nodes:await O.topics(t),resolve:async n=>new I({title:n.title,...$e(await O.latestByTopic(n.urn))})})}),new I({title:"TV Shows",nodes:["RSI","RTR","RTS","SRF","SWI"],resolve:async t=>new I({title:`${t} TV Shows`,nodes:await O.shows(t),resolve:async n=>new I({title:n.title,...$e(await O.latestByShow(n.urn))})})}),new I({title:"TV Latest Videos",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new I({title:`${t} TV Latest Videos`,...$e(await O.editorial(t))})}),new I({title:"TV Livestreams",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new I({title:`${t} TV Livestreams`,nodes:await O.livestreams(t)})}),new I({title:"Live web",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new I({title:`${t} Live web`,...$e(await O.scheduledLivestream(t))})}),new I({title:"Live center",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new I({title:`${t} Live center`,nodes:await O.livecenter(t)})}),new I({title:"Radio Shows",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new I({title:`${t} Radio Channels`,nodes:await O.channels(t),resolve:async n=>new I({title:`${n.title} Radio shows`,nodes:await O.radioShowByChannel(t,n.id),resolve:async e=>new I({title:e.title,...$e(await O.latestByShow(e.urn))})})})}),new I({title:"Radio Livestreams",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new I({title:`${t} Radio Livestreams`,nodes:await O.livestreams(t,"audio")})})];var Re,U,de,k,xe,Sn,En,Rn,Cn,_n,Tn,Ln,An,Mn,In,$n,Pn;class Ct extends D{constructor(){super();R(this,k);R(this,Re,new AbortController);R(this,U);R(this,de);this.loading=!1,Q(this,U,new nt(ri)),s(this,k,xe).call(this)}connectedCallback(){super.connectedCallback(),Q(this,de,async e=>{if(!e.detail.popstate)return;this.abortFetch();const o=new nt(y(this,U).root),{section:i,bu:a,nodes:r}=e.detail.queryParams;this.loading=!0;try{await o.initialize(i,a,r),Q(this,U,o),s(this,k,xe).call(this)}finally{this.loading=!1}}),w.addEventListener("queryparams",y(this,de))}disconnectedCallback(){super.disconnectedCallback(),this.abortFetch(),w.removeEventListener("queryparams",y(this,de))}firstUpdated(e){super.firstUpdated(e),y(this,de).call(this,{detail:{popstate:!0,queryParams:w.queryParams}})}async navigateTo(e,o){if(!y(this,U).isLeafSection(e)){this.abortFetch(),this.loading=!0;try{await y(this,U).fetchNextState(e,o),s(this,k,xe).call(this)}finally{this.loading=!1}}}abortFetch(){var e;return(e=y(this,Re))==null||e.abort("New search launched"),Q(this,Re,new AbortController),y(this,Re).signal}render(){const e=this.level.length===1&&this.level[0].next;return d`
    ...
    `}}Ce=new WeakMap,pe=new WeakMap,$=new WeakSet,On=async function(e,o){w.updateState({bu:e,...o?{query:o}:{}}),await s(this,$,Lt).call(this,e,o)},Lt=async function(e,o){const i=this.abortSearch();if(!o){[this.results,this.nextPage]=[null,null];return}this.loading=!0;try{const a=await O.search(e,o,i);[this.results,this.nextPage]=[a.results,a.next]}finally{this.loading=!1}},zn=async function(){const e=this.abortSearch(),o=await this.nextPage(e);this.nextPage=o.next,this.results=[...this.results,...o.results]},Un=function(e){return new URLSearchParams({...w.queryParams,src:e.urn,type:"srgssr/urn"}).toString()},Bn=function(e){const o=new Intl.DateTimeFormat("fr-CH").format(new Date(e.date)),i=Dt.formatTime(e.duration/1e3);return d`
    ...
    `},x(At,"properties",{autoplay:{type:Boolean,state:!0},muted:{type:Boolean,state:!0},debug:{type:Boolean,state:!0},dataProviderHost:{type:String,state:!0}}),x(At,"styles",[q,F,B(li)]);customElements.define("settings-page",At);w.addRoute("settings","settings-page");const mi=`@media screen and (prefers-color-scheme: dark){pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}/*!
