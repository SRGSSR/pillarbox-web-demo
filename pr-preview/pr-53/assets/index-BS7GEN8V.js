 ...
 */const tt=jo(class extends No{constructor(t){var n;if(super(t),t.type!==Oo.ATTRIBUTE||t.name!=="class"||((n=t.strings)==null?void 0:n.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(n=>t[n]).join(" ")+" "}update(t,[n]){var o,i;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in n)n[a]&&!((o=this.nt)!=null&&o.has(a))&&this.st.add(a);return this.render(n)}const e=t.element.classList;for(const a of this.st)a in n||(e.remove(a),this.st.delete(a));for(const a in n){const r=!!n[a];r===this.st.has(a)||(i=this.nt)!=null&&i.has(a)||(r?(e.add(a),this.st.add(a)):(e.remove(a),this.st.delete(a)))}return Po}});var A,wt,fn,kt,bn,dn,pn,hn,un,gn;class vt extends j{constructor(){super();C(this,A);this.src="",s(this,A,wt).call(this)}render(){const e={spin:this.drmSettingsShown===!0,"spin-back":this.drmSettingsShown===!1};return d`
    ...
    `},x(vt,"properties",{src:{type:String},drmSettings:{type:Object},drmSettingsShown:{state:!0,type:Boolean}}),x(vt,"styles",[q,F,B(Yo)]);customElements.define("load-media-form",vt);const Zo="[part=a]{display:flex;flex-direction:column;gap:var(--size-2);justify-content:center;min-height:var(--size-10);margin:0;color:var(--color-0);font-weight:var(--font-weight-6);font-size:var(--size-3);text-align:justify;text-decoration:none;background-color:var(--color-9);border:1px solid var(--color-10);transition:background-color .4s,border-color .4s;padding-inline:var(--size-3)}[part=a]:hover{text-decoration:none;background-color:var(--color-8);border-color:var(--color-9)}[part=title]{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}::slotted([slot=description]){display:flex;align-items:center;color:var(--color-6);font-weight:var(--font-weight-5);font-size:var(--size-3);font-style:italic}";var Pe;class xt extends j{constructor(){super(...arguments);C(this,Pe,e=>{e.preventDefault();const o=new URL(`${window.location.origin}/${this.href}`),i=Object.fromEntries(o.searchParams.entries());v.navigateTo(o.pathname,i)})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",y(this,Pe))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",y(this,Pe))}render(){return d`
 ...
 */function Y(t,n,e){return t?n(t):e==null?void 0:e(t)}class yn extends j{render(){return d`
  ...
  `]);customElements.define("scroll-to-top-button",wn);const pt=t=>t.replace(/\s+/g,"-").toLowerCase();var Q,kn,ze,Et,xn,Ct;const De=class De{constructor(n){C(this,Q);this.stack=[],this.level=n}async initialize(n,e,o){if(!n||!e)return;const i=s(this,Q,xn).call(this,n),a=s(this,Q,Ct).call(this,this.level[i].nodes,e);await this.fetchNextState(i,a),await s(this,Q,kn).call(this,o)}async fetchNextState(n,e){const o=this.level[n];this.stack.push({level:this.level,sectionIndex:n,nodeIndex:e}),this.level=[await o.resolve(o.nodes[e])]}fetchPreviousState(n){this.level=this.stack[n].level,this.stack.splice(n)}isLeafSection(n){var e;return(e=this.level[n])==null?void 0:e.isLeaf()}retrieveNode(n,e){var o;return(o=this.level[n])==null?void 0:o.nodes[e]}get root(){var n;return((n=this.stack[0])==null?void 0:n.level)||this.level}get params(){var n;return s(n=De,ze,Et).call(n,this.stack)}paramsAt(n,e){var o;return s(o=De,ze,Et).call(o,[...this.stack,{level:this.level,sectionIndex:n,nodeIndex:e}])}};Q=new WeakSet,kn=async function(n){for(const e of(n==null?void 0:n.split(","))||[]){const o=s(this,Q,Ct).call(this,this.level[0].nodes,e);await this.fetchNextState(0,o)}},ze=new WeakSet,Et=function(n){if(n.length===0)return{};const e=n[0],o=e.level[e.sectionIndex],i=n.slice(1).map(r=>{const l=r.level[r.sectionIndex].nodes[r.nodeIndex];return l.id||l.urn}),a={section:pt(o.title),bu:o.nodes[e.nodeIndex].toLowerCase()};return i&&i.length&&(a.nodes=i.join(",")),a},xn=function(n){const e=pt(n).toLowerCase();return this.level.map(o=>pt(o.title).toLowerCase()).findIndex(o=>o===e)},Ct=function(n,e){const o=e.toLowerCase();return n.map(i=>(i.urn||i.id||i.toString()).toLowerCase()).findIndex(i=>i===o)},C(De,ze);let nt=De;class M{constructor({title:n,nodes:e,resolve:o=void 0,next:i=void 0}){this.title=n,this.nodes=e,this.resolve=o,this.next=i}isLeaf(){return!this.resolve}async fetchNext(n=void 0){if(!this.next)return;const e=await this.next(n);return this.next=e.next,this.nodes.push(...e.results),e.results}}const $e=t=>({nodes:t.results,next:t.next}),oi=[new M({title:"TV Topics",nodes:["RSI","RTR","RTS","SRF","SWI"],resolve:async t=>new M({title:`${t} TV Topics`,nodes:await P.topics(t),resolve:async n=>new M({title:n.title,...$e(await P.latestByTopic(n.urn))})})}),new M({title:"TV Shows",nodes:["RSI","RTR","RTS","SRF","SWI"],resolve:async t=>new M({title:`${t} TV Shows`,nodes:await P.shows(t),resolve:async n=>new M({title:n.title,...$e(await P.latestByShow(n.urn))})})}),new M({title:"TV Latest Videos",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} TV Latest Videos`,...$e(await P.editorial(t))})}),new M({title:"TV Livestreams",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} TV Livestreams`,nodes:await P.livestreams(t)})}),new M({title:"Live web",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Live web`,...$e(await P.scheduledLivestream(t))})}),new M({title:"Live center",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Live center`,nodes:await P.livecenter(t)})}),new M({title:"Radio Shows",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Radio Channels`,nodes:await P.channels(t),resolve:async n=>new M({title:`${n.title} Radio shows`,nodes:await P.radioShowByChannel(t,n.id),resolve:async e=>new M({title:e.title,...$e(await P.latestByShow(e.urn))})})})}),new M({title:"Radio Livestreams",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Radio Livestreams`,nodes:await P.livestreams(t,"audio")})})];var Ce,U,de,k,xe,Sn,En,Cn,Rn,_n,Tn,Ln,An,Mn,In,$n,Dn;class Rt extends j{constructor(){super();C(this,k);C(this,Ce,new AbortController);C(this,U);C(this,de);this.loading=!1,J(this,U,new nt(oi)),s(this,k,xe).call(this)}connectedCallback(){super.connectedCallback(),J(this,de,async e=>{if(!e.detail.popstate)return;this.abortFetch();const o=new nt(y(this,U).root),{section:i,bu:a,nodes:r}=e.detail.queryParams;this.loading=!0;try{await o.initialize(i,a,r),J(this,U,o),s(this,k,xe).call(this)}finally{this.loading=!1}}),v.addEventListener("queryparams",y(this,de))}disconnectedCallback(){super.disconnectedCallback(),this.abortFetch(),v.removeEventListener("queryparams",y(this,de))}firstUpdated(e){super.firstUpdated(e),y(this,de).call(this,{detail:{popstate:!0,queryParams:v.queryParams}})}async navigateTo(e,o){if(!y(this,U).isLeafSection(e)){this.abortFetch(),this.loading=!0;try{await y(this,U).fetchNextState(e,o),s(this,k,xe).call(this)}finally{this.loading=!1}}}abortFetch(){var e;return(e=y(this,Ce))==null||e.abort("New search launched"),J(this,Ce,new AbortController),y(this,Ce).signal}render(){const e=this.level.length===1&&this.level[0].next;return d`
    ...
    `},_n=async function(e){const o=this.abortFetch();await e.fetchNext(o),s(this,k,xe).call(this)},Tn=function(e,o){const i=this.level[0],a=this.level.length===1&&i.next;return d`
        ${Ee(e,(r,l)=>d`
            ${Y(r.mediaType,()=>s(this,k,En).call(this,r,l),()=>s(this,k,Rn).call(this,r,o,l))}
        `)}
        ${Y(a,()=>d`
    ...
    `},In=function(){return d`
        <scroll-to-top-button></scroll-to-top-button>`},$n=function(e){e.target.tagName.toLowerCase()==="button"&&(this.abortFetch(),y(this,U).fetchPreviousState(e.target.dataset.navigationIdx),s(this,k,xe).call(this),v.updateState(y(this,U).params,["section","bu","nodes"]))},Dn=function(){return d`
    ...
    `}}ce=new WeakSet,jn=function(){this.query=this.renderRoot.querySelector("input").value},Nn=function(e){this.bu=e.target.value},On=function(){this.query="",this.renderRoot.querySelector("input").value=""},x(_t,"properties",{bu:{type:String},query:{type:String}}),x(_t,"styles",[q,F,B(ri)]);customElements.define("search-bar",_t);var Re,pe,$,Pn,Lt,zn,Un,Bn,Hn,qn,Fn;class Tt extends j{constructor(){super();C(this,$);C(this,Re,new AbortController);C(this,pe);this.loading=!1,this.results=null,this.nextPage=null}connectedCallback(){super.connectedCallback(),J(this,pe,()=>{const e=this.renderRoot.querySelector("search-bar");e.query=v.queryParams.query??"",e.bu=v.queryParams.bu??"rsi"}),v.addEventListener("queryparams",y(this,pe))}disconnectedCallback(){super.disconnectedCallback(),this.abortSearch(),v.removeEventListener("queryparams",y(this,pe))}async firstUpdated(e){super.firstUpdated(e);const o=this.renderRoot.querySelector("search-bar");y(this,pe).call(this),await s(this,$,Lt).call(this,o.bu,o.query)}abortSearch(){var e;return(e=y(this,Re))==null||e.abort("New search launched"),J(this,Re,new AbortController),y(this,Re).signal}render(){var e;return d`
      <search-bar
    ...
    `}}Re=new WeakMap,pe=new WeakMap,$=new WeakSet,Pn=async function(e,o){v.updateState({bu:e,...o?{query:o}:{}}),await s(this,$,Lt).call(this,e,o)},Lt=async function(e,o){const i=this.abortSearch();if(!o){[this.results,this.nextPage]=[null,null];return}this.loading=!0;try{const a=await P.search(e,o,i);[this.results,this.nextPage]=[a.results,a.next]}finally{this.loading=!1}},zn=async function(){const e=this.abortSearch(),o=await this.nextPage(e);this.nextPage=o.next,this.results=[...this.results,...o.results]},Un=function(e){return new URLSearchParams({...v.queryParams,src:e.urn,type:"srgssr/urn"}).toString()},Bn=function(e){const o=new Intl.DateTimeFormat("fr-CH").format(new Date(e.date)),i=jt.formatTime(e.duration/1e3);return d`
    ...
    `},Fn=function(){return d`
      <scroll-to-top-button></scroll-to-top-button>`},x(Tt,"properties",{loading:{state:!0,type:Boolean},results:{state:!0,type:Array},nextPage:{state:!0,type:Function}}),x(Tt,"styles",[q,F,B(ii)]);customElements.define("search-page",Tt);v.addRoute("search","search-page");const ai=':host{display:inline-block;cursor:pointer}[part=switch]{display:flex;align-items:center;width:var(--size-9);height:var(--size-7);background-color:var(--gray-6);border-radius:var(--radius-4);transition:.4s}[part=slider]{display:block;width:var(--size-5);height:var(--size-5);margin-left:var(--size-2);background-color:var(--gray-1);border-radius:var(--radius-round);transition:.4s;content:""}:host([checked]) [part=switch]{background-color:var(--green-8)}:host([checked]) [part=slider]{transform:translate(var(--size-5))}:host([disabled]) [part=switch]{cursor:not-allowed;opacity:.5}';var Ue,Be;class Je extends j{constructor(){super();C(this,Ue,e=>{e.key===" "&&(e.preventDefault(),this.toggle())});C(this,Be,()=>{this.toggle()});this.checked=!1,this.disabled=!1}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","switch"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0"),this.addEventListener("click",y(this,Be)),this.addEventListener("keydown",y(this,Ue))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",y(this,Be)),this.removeEventListener("keydown",y(this,Ue))}toggle(e){this.disabled||(this.checked=e??!this.checked)}updated(e){super.updated(e),e.has("checked")&&(this.setAttribute("aria-checked",this.checked.toString()),this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked}})))}render(){return d`
        <div part="switch">
            <div part="slider"></div>
        </div>
    ...
    `},x(At,"properties",{autoplay:{type:Boolean,state:!0},muted:{type:Boolean,state:!0},debug:{type:Boolean,state:!0},dataProviderHost:{type:String,state:!0}}),x(At,"styles",[q,F,B(ci)]);customElements.define("settings-page",At);v.addRoute("settings","settings-page");const si=`@media screen and (prefers-color-scheme: dark){pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}/*!
...
`)[0].match(/^ */)[0].length,i=new RegExp(`^ {${o}}`,"gm");return n.replace(i,"")}const vr=new DOMParser;function ee(t,n="[data-implementation]"){return yr(vr.parseFromString(t,"text/html").querySelector(n).textContent)}const wr=ee(lr),kr=ee(mr),xr=ee(fr),Sr=ee(br),Er=ee(dr),Cr=ee(pr),Rr=ee(hr),_r=ee(ur),Tr=ee(gr);var I,po,ho,uo,go,yo,vo,wo,ko,xo;class bo extends j{constructor(){super(...arguments);C(this,I)}render(){return d`
