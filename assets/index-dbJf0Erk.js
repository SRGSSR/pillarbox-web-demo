var Do=Object.defineProperty;var Vt=t=>{throw TypeError(t)};var $o=(t,n,e)=>n in t?Do(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var x=(t,n,e)=>$o(t,typeof n!="symbol"?n+"":n,e),dt=(t,n,e)=>n.has(t)||Vt("Cannot "+e);var y=(t,n,e)=>(dt(t,n,"read from private field"),e?e.call(t):n.get(t)),R=(t,n,e)=>n.has(t)?Vt("Cannot add the same private member more than once"):n instanceof WeakSet?n.add(t):n.set(t,e),J=(t,n,e,o)=>(dt(t,n,"write to private field"),o?o.call(t,e):n.set(t,e),e),s=(t,n,e)=>(dt(t,n,"access private method"),e);import{r as j,t as q,a as F,b as B,x as d,p as $t,c as w,e as jo,i as No,d as Oo,T as Po,f as tn,v as jt,g as zo,o as nn}from"./core-demo-header-component-BNyRgtzK.js";const Uo="[part=container]{block-size:480px;aspect-ratio:var(--ratio-widescreen);padding:0;overflow:visible;background-color:var(--color-12)}[part=close-btn]{position:absolute;top:calc(var(--size-3) * -1);right:0;z-index:2;width:var(--size-7);height:var(--size-7);font-size:var(--size-4);text-align:center;background:var(--gray-6);border-radius:var(--radius-round)}";var ie,Te,on,rn;class gt extends j{constructor(){super();R(this,Te);R(this,ie);this.open=!1}updated(e){super.updated(e),e.has("open")&&(this.open?(y(this,ie).showModal(),y(this,ie).classList.toggle("slide-up-fade-in",!0)):y(this,ie).close())}firstUpdated(e){super.firstUpdated(e),J(this,ie,this.shadowRoot.querySelector("dialog"))}render(){return d`
 ...
 */function Y(t,n,e){return t?n(t):e==null?void 0:e(t)}class yn extends j{render(){return d`
    ...
    `}}x(yn,"styles",[q,F,tn`
      .example-section p {
        ...
        text-align: left;
      }`]);customElements.define("examples-page",yn);w.addRoute("examples","examples-page");const Qo=".tree-navigation-container{display:flex;align-items:end}.tree-navigation-container button{padding:0;color:var(--color-6);background:transparent;border:none}.tree-navigation-container button:hover{color:inherit}.tree-navigation-container i{font-size:var(--size-3)}intersection-observer::part(sentinel){width:100%;height:var(--size-9);margin-top:var(--size-4);background-color:var(--color-9);border:1px solid var(--color-10);border-radius:var(--radius-3);animation:var(--animation-blink)}",ei=".spinner{display:block;width:var(--size-7);height:var(--size-7);border:3px solid var(--color-2);border-bottom-color:transparent;border-radius:var(--radius-round);animation:var(--animation-spin)}.spinner-container{display:grid;place-content:center;margin:var(--size-10)}.spinner-container.hidden{display:none}";class St extends j{constructor(){super(),this.loading=!1}render(){return d`
      <div class="spinner-container ${this.loading?"":"hidden"}">
        <div class="spinner"></div>
      </div>
    `}}x(St,"properties",{loading:{type:Boolean,reflect:!0}}),x(St,"styles",[F,B(ei)]);customElements.define("loading-spinner",St);const ti={root:null,rootMargin:"0px",threshold:.1},ni=(t,n,e=ti)=>{new IntersectionObserver(o=>{o.forEach(i=>{i.isIntersecting&&n()})},e).observe(t)};class wn extends j{firstUpdated(n){super.firstUpdated(n),ni(this.renderRoot.querySelector("div"),()=>{this.dispatchEvent(new CustomEvent("intersecting"))})}render(){return d`
  ...
  `]);customElements.define("scroll-to-top-button",vn);const pt=t=>t.replace(/\s+/g,"-").toLowerCase();var Q,kn,ze,Et,xn,Rt;const $e=class $e{constructor(n){R(this,Q);this.stack=[],this.level=n}async initialize(n,e,o){if(!n||!e)return;const i=s(this,Q,xn).call(this,n),a=s(this,Q,Rt).call(this,this.level[i].nodes,e);await this.fetchNextState(i,a),await s(this,Q,kn).call(this,o)}async fetchNextState(n,e){const o=this.level[n];this.stack.push({level:this.level,sectionIndex:n,nodeIndex:e}),this.level=[await o.resolve(o.nodes[e])]}fetchPreviousState(n){this.level=this.stack[n].level,this.stack.splice(n)}isLeafSection(n){var e;return(e=this.level[n])==null?void 0:e.isLeaf()}retrieveNode(n,e){var o;return(o=this.level[n])==null?void 0:o.nodes[e]}get root(){var n;return((n=this.stack[0])==null?void 0:n.level)||this.level}get params(){var n;return s(n=$e,ze,Et).call(n,this.stack)}paramsAt(n,e){var o;return s(o=$e,ze,Et).call(o,[...this.stack,{level:this.level,sectionIndex:n,nodeIndex:e}])}};Q=new WeakSet,kn=async function(n){for(const e of(n==null?void 0:n.split(","))||[]){const o=s(this,Q,Rt).call(this,this.level[0].nodes,e);await this.fetchNextState(0,o)}},ze=new WeakSet,Et=function(n){if(n.length===0)return{};const e=n[0],o=e.level[e.sectionIndex],i=n.slice(1).map(r=>{const l=r.level[r.sectionIndex].nodes[r.nodeIndex];return l.id||l.urn}),a={section:pt(o.title),bu:o.nodes[e.nodeIndex].toLowerCase()};return i&&i.length&&(a.nodes=i.join(",")),a},xn=function(n){const e=pt(n).toLowerCase();return this.level.map(o=>pt(o.title).toLowerCase()).findIndex(o=>o===e)},Rt=function(n,e){const o=e.toLowerCase();return n.map(i=>(i.urn||i.id||i.toString()).toLowerCase()).findIndex(i=>i===o)},R($e,ze);let nt=$e;class M{constructor({title:n,nodes:e,resolve:o=void 0,next:i=void 0}){this.title=n,this.nodes=e,this.resolve=o,this.next=i}isLeaf(){return!this.resolve}async fetchNext(n=void 0){if(!this.next)return;const e=await this.next(n);return this.next=e.next,this.nodes.push(...e.results),e.results}}const De=t=>({nodes:t.results,next:t.next}),oi=[new M({title:"TV Topics",nodes:["RSI","RTR","RTS","SRF","SWI"],resolve:async t=>new M({title:`${t} TV Topics`,nodes:await P.topics(t),resolve:async n=>new M({title:n.title,...De(await P.latestByTopic(n.urn))})})}),new M({title:"TV Shows",nodes:["RSI","RTR","RTS","SRF","SWI"],resolve:async t=>new M({title:`${t} TV Shows`,nodes:await P.shows(t),resolve:async n=>new M({title:n.title,...De(await P.latestByShow(n.urn))})})}),new M({title:"TV Latest Videos",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} TV Latest Videos`,...De(await P.editorial(t))})}),new M({title:"TV Livestreams",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} TV Livestreams`,nodes:await P.livestreams(t)})}),new M({title:"Live web",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Live web`,...De(await P.scheduledLivestream(t))})}),new M({title:"Live center",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Live center`,nodes:await P.livecenter(t)})}),new M({title:"Radio Shows",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Radio Channels`,nodes:await P.channels(t),resolve:async n=>new M({title:`${n.title} Radio shows`,nodes:await P.radioShowByChannel(t,n.id),resolve:async e=>new M({title:e.title,...De(await P.latestByShow(e.urn))})})})}),new M({title:"Radio Livestreams",nodes:["RSI","RTR","RTS","SRF"],resolve:async t=>new M({title:`${t} Radio Livestreams`,nodes:await P.livestreams(t,"audio")})})];var Re,U,de,k,xe,Sn,En,Rn,Cn,_n,Tn,Ln,An,Mn,In,Dn,$n;class Ct extends j{constructor(){super();R(this,k);R(this,Re,new AbortController);R(this,U);R(this,de);this.loading=!1,J(this,U,new nt(oi)),s(this,k,xe).call(this)}connectedCallback(){super.connectedCallback(),J(this,de,async e=>{if(!e.detail.popstate)return;this.abortFetch();const o=new nt(y(this,U).root),{section:i,bu:a,nodes:r}=e.detail.queryParams;this.loading=!0;try{await o.initialize(i,a,r),J(this,U,o),s(this,k,xe).call(this)}finally{this.loading=!1}}),w.addEventListener("queryparams",y(this,de))}disconnectedCallback(){super.disconnectedCallback(),this.abortFetch(),w.removeEventListener("queryparams",y(this,de))}firstUpdated(e){super.firstUpdated(e),y(this,de).call(this,{detail:{popstate:!0,queryParams:w.queryParams}})}async navigateTo(e,o){if(!y(this,U).isLeafSection(e)){this.abortFetch(),this.loading=!0;try{await y(this,U).fetchNextState(e,o),s(this,k,xe).call(this)}finally{this.loading=!1}}}abortFetch(){var e;return(e=y(this,Re))==null||e.abort("New search launched"),J(this,Re,new AbortController),y(this,Re).signal}render(){const e=this.level.length===1&&this.level[0].next;return d`
    ...
    `},In=function(){return d`
        <scroll-to-top-button></scroll-to-top-button>`},Dn=function(e){e.target.tagName.toLowerCase()==="button"&&(this.abortFetch(),y(this,U).fetchPreviousState(e.target.dataset.navigationIdx),s(this,k,xe).call(this),w.updateState(y(this,U).params,["section","bu","nodes"]))},$n=function(){return d`
        <div class="tree-navigation-container"
             @click="${s(this,k,Dn).bind(this)}">
    ...
    `}}ce=new WeakSet,jn=function(){this.query=this.renderRoot.querySelector("input").value},Nn=function(e){this.bu=e.target.value},On=function(){this.query="",this.renderRoot.querySelector("input").value=""},x(_t,"properties",{bu:{type:String},query:{type:String}}),x(_t,"styles",[q,F,B(ri)]);customElements.define("search-bar",_t);var Ce,pe,D,Pn,Lt,zn,Un,Bn,Hn,qn,Fn;class Tt extends j{constructor(){super();R(this,D);R(this,Ce,new AbortController);R(this,pe);this.loading=!1,this.results=null,this.nextPage=null}connectedCallback(){super.connectedCallback(),J(this,pe,()=>{const e=this.renderRoot.querySelector("search-bar");e.query=w.queryParams.query??"",e.bu=w.queryParams.bu??"rsi"}),w.addEventListener("queryparams",y(this,pe))}disconnectedCallback(){super.disconnectedCallback(),this.abortSearch(),w.removeEventListener("queryparams",y(this,pe))}async firstUpdated(e){super.firstUpdated(e);const o=this.renderRoot.querySelector("search-bar");y(this,pe).call(this),await s(this,D,Lt).call(this,o.bu,o.query)}abortSearch(){var e;return(e=y(this,Ce))==null||e.abort("New search launched"),J(this,Ce,new AbortController),y(this,Ce).signal}render(){var e;return d`
      <search-bar
        @change="${o=>s(this,D,Pn).call(this,o.detail.bu,o.detail.query)}">
      </search-bar>

      <!-- Search results -->
      ${Y(this.loading,s(this,D,qn).bind(this),s(this,D,Hn).bind(this))}
      ${Y(((e=this.results)==null?void 0:e.length)>0,s(this,D,Fn).bind(this))}
    `}}Ce=new WeakMap,pe=new WeakMap,D=new WeakSet,Pn=async function(e,o){w.updateState({bu:e,...o?{query:o}:{}}),await s(this,D,Lt).call(this,e,o)},Lt=async function(e,o){const i=this.abortSearch();if(!o){[this.results,this.nextPage]=[null,null];return}this.loading=!0;try{const a=await P.search(e,o,i);[this.results,this.nextPage]=[a.results,a.next]}finally{this.loading=!1}},zn=async function(){const e=this.abortSearch(),o=await this.nextPage(e);this.nextPage=o.next,this.results=[...this.results,...o.results]},Un=function(e){return new URLSearchParams({...w.queryParams,src:e.urn,type:"srgssr/urn"}).toString()},Bn=function(e){const o=new Intl.DateTimeFormat("fr-CH").format(new Date(e.date)),i=jt.formatTime(e.duration/1e3);return d`
    ...
    `},x(At,"properties",{autoplay:{type:Boolean,state:!0},muted:{type:Boolean,state:!0},debug:{type:Boolean,state:!0},dataProviderHost:{type:String,state:!0}}),x(At,"styles",[q,F,B(ci)]);customElements.define("settings-page",At);w.addRoute("settings","settings-page");const si=`@media screen and (prefers-color-scheme: dark){pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}/*!
...
*/.hljs{color:#24292e;background:#fff}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:#d73a49}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#6f42c1}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-variable,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id{color:#005cc5}.hljs-regexp,.hljs-string,.hljs-meta .hljs-string{color:#032f62}.hljs-built_in,.hljs-symbol{color:#e36209}.hljs-comment,.hljs-code,.hljs-formula{color:#6a737d}.hljs-name,.hljs-quote,.hljs-selector-tag,.hljs-selector-pseudo{color:#22863a}.hljs-subst{color:#24292e}.hljs-section{color:#005cc5;font-weight:700}.hljs-bullet{color:#735c0f}.hljs-emphasis{color:#24292e;font-style:italic}.hljs-strong{color:#24292e;font-weight:700}.hljs-addition{color:#22863a;background-color:#f0fff4}.hljs-deletion{color:#b31d28;background-color:#ffeef0}}[part=container]{overflow-x:auto;font-size:var(--font-size-0)}slot{display:none}`;function Vn(t){return t instanceof Map?t.clear=t.delete=t.set=function(){throw new Error("map is read-only")}:t instanceof Set&&(t.add=t.clear=t.delete=function(){throw new Error("set is read-only")}),Object.freeze(t),Object.getOwnPropertyNames(t).forEach(n=>{const e=t[n],o=typeof e;(o==="object"||o==="function")&&!Object.isFrozen(e)&&Vn(e)}),t}class Wt{constructor(n){n.data===void 0&&(n.data={}),this.data=n.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function Wn(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function re(t,...n){const e=Object.create(null);for(const o in t)e[o]=t[o];return n.forEach(function(o){for(const i in o)e[i]=o[i]}),e}const li="</span>",Kt=t=>!!t.scope,mi=(t,{prefix:n})=>{if(t.startsWith("language:"))return t.replace("language:","language-");if(t.includes(".")){const e=t.split(".");return[`${n}${e.shift()}`,...e.map((o,i)=>`${o}${"_".repeat(i+1)}`)].join(" ")}return`${n}${t}`};class fi{constructor(n,e){this.buffer="",this.classPrefix=e.classPrefix,n.walk(this)}addText(n){this.buffer+=Wn(n)}openNode(n){if(!Kt(n))return;const e=mi(n.scope,{prefix:this.classPrefix});this.span(e)}closeNode(n){Kt(n)&&(this.buffer+=li)}value(){return this.buffer}span(n){this.buffer+=`<span class="${n}">`}}const Xt=(t={})=>{const n={children:[]};return Object.assign(n,t),n};class Nt{constructor(){this.rootNode=Xt(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(n){this.top.children.push(n)}openNode(n){const e=Xt({scope:n});this.add(e),this.stack.push(e)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(n){return this.constructor._walk(n,this.rootNode)}static _walk(n,e){return typeof e=="string"?n.addText(e):e.children&&(n.openNode(e),e.children.forEach(o=>this._walk(n,o)),n.closeNode(e)),n}static _collapse(n){typeof n!="string"&&n.children&&(n.children.every(e=>typeof e=="string")?n.children=[n.children.join("")]:n.children.forEach(e=>{Nt._collapse(e)}))}}class bi extends Nt{constructor(n){super(),this.options=n}addText(n){n!==""&&this.add(n)}startScope(n){this.openNode(n)}endScope(){this.closeNode()}__addSublanguage(n,e){const o=n.root;e&&(o.scope=`language:${e}`),this.add(o)}toHTML(){return new fi(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function je(t){return t?typeof t=="string"?t:t.source:null}function Kn(t){return ge("(?=",t,")")}function di(t){return ge("(?:",t,")*")}function pi(t){return ge("(?:",t,")?")}function ge(...t){return t.map(e=>je(e)).join("")}function hi(t){const n=t[t.length-1];return typeof n=="object"&&n.constructor===Object?(t.splice(t.length-1,1),n):{}}function Ot(...t){return"("+(hi(t).capture?"":"?:")+t.map(o=>je(o)).join("|")+")"}function Xn(t){return new RegExp(t.toString()+"|").exec("").length-1}function ui(t,n){const e=t&&t.exec(n);return e&&e.index===0}const gi=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function Pt(t,{joinWith:n}){let e=0;return t.map(o=>{e+=1;const i=e;let a=je(o),r="";for(;a.length>0;){const l=gi.exec(a);if(!l){r+=a;break}r+=a.substring(0,l.index),a=a.substring(l.index+l[0].length),l[0][0]==="\\"&&l[1]?r+="\\"+String(Number(l[1])+i):(r+=l[0],l[0]==="("&&e++)}return r}).map(o=>`(${o})`).join(n)}const yi=/\b\B/,Yn="[a-zA-Z]\\w*",zt="[a-zA-Z_]\\w*",Zn="\\b\\d+(\\.\\d+)?",Jn="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",Qn="\\b(0b[01]+)",wi="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",vi=(t={})=>{const n=/^#![ ]*\//;return t.binary&&(t.begin=ge(n,/.*\b/,t.binary,/\b.*/)),re({scope:"meta",begin:n,end:/$/,relevance:0,"on:begin":(e,o)=>{e.index!==0&&o.ignoreMatch()}},t)},Ne={begin:"\\\\[\\s\\S]",relevance:0},ki={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[Ne]},xi={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[Ne]},Si={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},rt=function(t,n,e={}){const o=re({scope:"comment",begin:t,end:n,contains:[]},e);o.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const i=Ot("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return o.contains.push({begin:ge(/[ ]+/,"(",i,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),o},Ei=rt("//","$"),Ri=rt("/\\*","\\*/"),Ci=rt("#","$"),_i={scope:"number",begin:Zn,relevance:0},Ti={scope:"number",begin:Jn,relevance:0},Li={scope:"number",begin:Qn,relevance:0},Ai={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[Ne,{begin:/\[/,end:/\]/,relevance:0,contains:[Ne]}]},Mi={scope:"title",begin:Yn,relevance:0},Ii={scope:"title",begin:zt,relevance:0},Di={begin:"\\.\\s*"+zt,relevance:0},$i=function(t){return Object.assign(t,{"on:begin":(n,e)=>{e.data._beginMatch=n[1]},"on:end":(n,e)=>{e.data._beginMatch!==n[1]&&e.ignoreMatch()}})};var Ze=Object.freeze({__proto__:null,APOS_STRING_MODE:ki,BACKSLASH_ESCAPE:Ne,BINARY_NUMBER_MODE:Li,BINARY_NUMBER_RE:Qn,COMMENT:rt,C_BLOCK_COMMENT_MODE:Ri,C_LINE_COMMENT_MODE:Ei,C_NUMBER_MODE:Ti,C_NUMBER_RE:Jn,END_SAME_AS_BEGIN:$i,HASH_COMMENT_MODE:Ci,IDENT_RE:Yn,MATCH_NOTHING_RE:yi,METHOD_GUARD:Di,NUMBER_MODE:_i,NUMBER_RE:Zn,PHRASAL_WORDS_MODE:Si,QUOTE_STRING_MODE:xi,REGEXP_MODE:Ai,RE_STARTERS_RE:wi,SHEBANG:vi,TITLE_MODE:Mi,UNDERSCORE_IDENT_RE:zt,UNDERSCORE_TITLE_MODE:Ii});function ji(t,n){t.input[t.index-1]==="."&&n.ignoreMatch()}function Ni(t,n){t.className!==void 0&&(t.scope=t.className,delete t.className)}function Oi(t,n){n&&t.beginKeywords&&(t.begin="\\b("+t.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",t.__beforeBegin=ji,t.keywords=t.keywords||t.beginKeywords,delete t.beginKeywords,t.relevance===void 0&&(t.relevance=0))}function Pi(t,n){Array.isArray(t.illegal)&&(t.illegal=Ot(...t.illegal))}function zi(t,n){if(t.match){if(t.begin||t.end)throw new Error("begin & end are not supported with match");t.begin=t.match,delete t.match}}function Ui(t,n){t.relevance===void 0&&(t.relevance=1)}const Bi=(t,n)=>{if(!t.beforeMatch)return;if(t.starts)throw new Error("beforeMatch cannot be used with starts");const e=Object.assign({},t);Object.keys(t).forEach(o=>{delete t[o]}),t.keywords=e.keywords,t.begin=ge(e.beforeMatch,Kn(e.begin)),t.starts={relevance:0,contains:[Object.assign(e,{endsParent:!0})]},t.relevance=0,delete e.beforeMatch},Hi=["of","and","for","in","not","or","if","then","parent","list","value"],qi="keyword";function eo(t,n,e=qi){const o=Object.create(null);return typeof t=="string"?i(e,t.split(" ")):Array.isArray(t)?i(e,t):Object.keys(t).forEach(function(a){Object.assign(o,eo(t[a],n,a))}),o;function i(a,r){n&&(r=r.map(l=>l.toLowerCase())),r.forEach(function(l){const p=l.split("|");o[p[0]]=[a,Fi(p[0],p[1])]})}}function Fi(t,n){return n?Number(n):Gi(t)?0:1}function Gi(t){return Hi.includes(t.toLowerCase())}const Yt={},ue=t=>{console.error(t)},Zt=(t,...n)=>{console.log(`WARN: ${t}`,...n)},ke=(t,n)=>{Yt[`${t}/${n}`]||(console.log(`Deprecated as of ${t}. ${n}`),Yt[`${t}/${n}`]=!0)},ot=new Error;function to(t,n,{key:e}){let o=0;const i=t[e],a={},r={};for(let l=1;l<=n.length;l++)r[l+o]=i[l],a[l+o]=!0,o+=Xn(n[l-1]);t[e]=r,t[e]._emit=a,t[e]._multi=!0}function Vi(t){if(Array.isArray(t.begin)){if(t.skip||t.excludeBegin||t.returnBegin)throw ue("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),ot;if(typeof t.beginScope!="object"||t.beginScope===null)throw ue("beginScope must be object"),ot;to(t,t.begin,{key:"beginScope"}),t.begin=Pt(t.begin,{joinWith:""})}}function Wi(t){if(Array.isArray(t.end)){if(t.skip||t.excludeEnd||t.returnEnd)throw ue("skip, excludeEnd, returnEnd not compatible with endScope: {}"),ot;if(typeof t.endScope!="object"||t.endScope===null)throw ue("endScope must be object"),ot;to(t,t.end,{key:"endScope"}),t.end=Pt(t.end,{joinWith:""})}}function Ki(t){t.scope&&typeof t.scope=="object"&&t.scope!==null&&(t.beginScope=t.scope,delete t.scope)}function Xi(t){Ki(t),typeof t.beginScope=="string"&&(t.beginScope={_wrap:t.beginScope}),typeof t.endScope=="string"&&(t.endScope={_wrap:t.endScope}),Vi(t),Wi(t)}function Yi(t){function n(r,l){return new RegExp(je(r),"m"+(t.case_insensitive?"i":"")+(t.unicodeRegex?"u":"")+(l?"g":""))}class e{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(l,p){p.position=this.position++,this.matchIndexes[this.matchAt]=p,this.regexes.push([p,l]),this.matchAt+=Xn(l)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const l=this.regexes.map(p=>p[1]);this.matcherRe=n(Pt(l,{joinWith:"|"}),!0),this.lastIndex=0}exec(l){this.matcherRe.lastIndex=this.lastIndex;const p=this.matcherRe.exec(l);if(!p)return null;const _=p.findIndex((te,V)=>V>0&&te!==void 0),T=this.matchIndexes[_];return p.splice(0,_),Object.assign(p,T)}}class o{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(l){if(this.multiRegexes[l])return this.multiRegexes[l];const p=new e;return this.rules.slice(l).forEach(([_,T])=>p.addRule(_,T)),p.compile(),this.multiRegexes[l]=p,p}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(l,p){this.rules.push([l,p]),p.type==="begin"&&this.count++}exec(l){const p=this.getMatcher(this.regexIndex);p.lastIndex=this.lastIndex;let _=p.exec(l);if(this.resumingScanAtSamePosition()&&!(_&&_.index===this.lastIndex)){const T=this.getMatcher(0);T.lastIndex=this.lastIndex+1,_=T.exec(l)}return _&&(this.regexIndex+=_.position+1,this.regexIndex===this.count&&this.considerAll()),_}}function i(r){const l=new o;return r.contains.forEach(p=>l.addRule(p.begin,{rule:p,type:"begin"})),r.terminatorEnd&&l.addRule(r.terminatorEnd,{type:"end"}),r.illegal&&l.addRule(r.illegal,{type:"illegal"}),l}function a(r,l){const p=r;if(r.isCompiled)return p;[Ni,zi,Xi,Bi].forEach(T=>T(r,l)),t.compilerExtensions.forEach(T=>T(r,l)),r.__beforeBegin=null,[Oi,Pi,Ui].forEach(T=>T(r,l)),r.isCompiled=!0;let _=null;return typeof r.keywords=="object"&&r.keywords.$pattern&&(r.keywords=Object.assign({},r.keywords),_=r.keywords.$pattern,delete r.keywords.$pattern),_=_||/\w+/,r.keywords&&(r.keywords=eo(r.keywords,t.case_insensitive)),p.keywordPatternRe=n(_,!0),l&&(r.begin||(r.begin=/\B|\b/),p.beginRe=n(p.begin),!r.end&&!r.endsWithParent&&(r.end=/\B|\b/),r.end&&(p.endRe=n(p.end)),p.terminatorEnd=je(p.end)||"",r.endsWithParent&&l.terminatorEnd&&(p.terminatorEnd+=(r.end?"|":"")+l.terminatorEnd)),r.illegal&&(p.illegalRe=n(r.illegal)),r.contains||(r.contains=[]),r.contains=[].concat(...r.contains.map(function(T){return Zi(T==="self"?r:T)})),r.contains.forEach(function(T){a(T,p)}),r.starts&&a(r.starts,l),p.matcher=i(p),p}if(t.compilerExtensions||(t.compilerExtensions=[]),t.contains&&t.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return t.classNameAliases=re(t.classNameAliases||{}),a(t)}function no(t){return t?t.endsWithParent||no(t.starts):!1}function Zi(t){return t.variants&&!t.cachedVariants&&(t.cachedVariants=t.variants.map(function(n){return re(t,{variants:null},n)})),t.cachedVariants?t.cachedVariants:no(t)?re(t,{starts:t.starts?re(t.starts):null}):Object.isFrozen(t)?re(t):t}var Ji="11.10.0";class Qi extends Error{constructor(n,e){super(n),this.name="HTMLInjectionError",this.html=e}}const ut=Wn,Jt=re,Qt=Symbol("nomatch"),er=7,oo=function(t){const n=Object.create(null),e=Object.create(null),o=[];let i=!0;const a="Could not find the language '{}', did you forget to load/include a language module?",r={disableAutodetect:!0,name:"Plain text",contains:[]};let l={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:bi};function p(c){return l.noHighlightRe.test(c)}function _(c){let f=c.className+" ";f+=c.parentNode?c.parentNode.className:"";const u=l.languageDetectRe.exec(f);if(u){const v=W(u[1]);return v||(Zt(a.replace("{}",u[1])),Zt("Falling back to no-highlight mode for this block.",c)),v?u[1]:"no-highlight"}return f.split(/\s+/).find(v=>p(v)||W(v))}function T(c,f,u){let v="",C="";typeof f=="object"?(v=c,u=f.ignoreIllegals,C=f.language):(ke("10.7.0","highlight(lang, code, ...args) has been deprecated."),ke("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),C=c,v=f),u===void 0&&(u=!0);const O={code:v,language:C};ve("before:highlight",O);const G=O.result?O.result:te(O.language,O.code,u);return G.code=O.code,ve("after:highlight",G),G}function te(c,f,u,v){const C=Object.create(null);function O(m,b){return m.keywords[b]}function G(){if(!h.keywords){$.addText(E);return}let m=0;h.keywordPatternRe.lastIndex=0;let b=h.keywordPatternRe.exec(E),g="";for(;b;){g+=E.substring(m,b.index);const S=X.case_insensitive?b[0].toLowerCase():b[0],N=O(h,S);if(N){const[Z,Mo]=N;if($.addText(g),g="",C[S]=(C[S]||0)+1,C[S]<=er&&(Ye+=Mo),Z.startsWith("_"))g+=b[0];else{const Io=X.classNameAliases[Z]||Z;K(b[0],Io)}}else g+=b[0];m=h.keywordPatternRe.lastIndex,b=h.keywordPatternRe.exec(E)}g+=E.substring(m),$.addText(g)}function Ke(){if(E==="")return;let m=null;if(typeof h.subLanguage=="string"){if(!n[h.subLanguage]){$.addText(E);return}m=te(h.subLanguage,E,!0,Gt[h.subLanguage]),Gt[h.subLanguage]=m._top}else m=ye(E,h.subLanguage.length?h.subLanguage:null);h.relevance>0&&(Ye+=m.relevance),$.__addSublanguage(m._emitter,m.language)}function z(){h.subLanguage!=null?Ke():G(),E=""}function K(m,b){m!==""&&($.startScope(b),$.addText(m),$.endScope())}function Bt(m,b){let g=1;const S=b.length-1;for(;g<=S;){if(!m._emit[g]){g++;continue}const N=X.classNameAliases[m[g]]||m[g],Z=b[g];N?K(Z,N):(E=Z,G(),E=""),g++}}function Ht(m,b){return m.scope&&typeof m.scope=="string"&&$.openNode(X.classNameAliases[m.scope]||m.scope),m.beginScope&&(m.beginScope._wrap?(K(E,X.classNameAliases[m.beginScope._wrap]||m.beginScope._wrap),E=""):m.beginScope._multi&&(Bt(m.beginScope,b),E="")),h=Object.create(m,{parent:{value:h}}),h}function qt(m,b,g){let S=ui(m.endRe,g);if(S){if(m["on:end"]){const N=new Wt(m);m["on:end"](b,N),N.isMatchIgnored&&(S=!1)}if(S){for(;m.endsParent&&m.parent;)m=m.parent;return m}}if(m.endsWithParent)return qt(m.parent,b,g)}function Co(m){return h.matcher.regexIndex===0?(E+=m[0],1):(bt=!0,0)}function _o(m){const b=m[0],g=m.rule,S=new Wt(g),N=[g.__beforeBegin,g["on:begin"]];for(const Z of N)if(Z&&(Z(m,S),S.isMatchIgnored))return Co(b);return g.skip?E+=b:(g.excludeBegin&&(E+=b),z(),!g.returnBegin&&!g.excludeBegin&&(E=b)),Ht(g,m),g.returnBegin?0:b.length}function To(m){const b=m[0],g=f.substring(m.index),S=qt(h,m,g);if(!S)return Qt;const N=h;h.endScope&&h.endScope._wrap?(z(),K(b,h.endScope._wrap)):h.endScope&&h.endScope._multi?(z(),Bt(h.endScope,m)):N.skip?E+=b:(N.returnEnd||N.excludeEnd||(E+=b),z(),N.excludeEnd&&(E=b));do h.scope&&$.closeNode(),!h.skip&&!h.subLanguage&&(Ye+=h.relevance),h=h.parent;while(h!==S.parent);return S.starts&&Ht(S.starts,m),N.returnEnd?0:b.length}function Lo(){const m=[];for(let b=h;b!==X;b=b.parent)b.scope&&m.unshift(b.scope);m.forEach(b=>$.openNode(b))}let Xe={};function Ft(m,b){const g=b&&b[0];if(E+=m,g==null)return z(),0;if(Xe.type==="begin"&&b.type==="end"&&Xe.index===b.index&&g===""){if(E+=f.slice(b.index,b.index+1),!i){const S=new Error(`0 width match regex (${c})`);throw S.languageName=c,S.badRule=Xe.rule,S}return 1}if(Xe=b,b.type==="begin")return _o(b);if(b.type==="illegal"&&!u){const S=new Error('Illegal lexeme "'+g+'" for mode "'+(h.scope||"<unnamed>")+'"');throw S.mode=h,S}else if(b.type==="end"){const S=To(b);if(S!==Qt)return S}if(b.type==="illegal"&&g==="")return 1;if(ft>1e5&&ft>b.index*3)throw new Error("potential infinite loop, way more iterations than matches");return E+=g,g.length}const X=W(c);if(!X)throw ue(a.replace("{}",c)),new Error('Unknown language: "'+c+'"');const Ao=Yi(X);let mt="",h=v||Ao;const Gt={},$=new l.__emitter(l);Lo();let E="",Ye=0,fe=0,ft=0,bt=!1;try{if(X.__emitTokens)X.__emitTokens(f,$);else{for(h.matcher.considerAll();;){ft++,bt?bt=!1:h.matcher.considerAll(),h.matcher.lastIndex=fe;const m=h.matcher.exec(f);if(!m)break;const b=f.substring(fe,m.index),g=Ft(b,m);fe=m.index+g}Ft(f.substring(fe))}return $.finalize(),mt=$.toHTML(),{language:c,value:mt,relevance:Ye,illegal:!1,_emitter:$,_top:h}}catch(m){if(m.message&&m.message.includes("Illegal"))return{language:c,value:ut(f),illegal:!0,relevance:0,_illegalBy:{message:m.message,index:fe,context:f.slice(fe-100,fe+100),mode:m.mode,resultSoFar:mt},_emitter:$};if(i)return{language:c,value:ut(f),illegal:!1,relevance:0,errorRaised:m,_emitter:$,_top:h};throw m}}function V(c){const f={value:ut(c),illegal:!1,relevance:0,_top:r,_emitter:new l.__emitter(l)};return f._emitter.addText(c),f}function ye(c,f){f=f||l.languages||Object.keys(n);const u=V(c),v=f.filter(W).filter(Ve).map(z=>te(z,c,!1));v.unshift(u);const C=v.sort((z,K)=>{if(z.relevance!==K.relevance)return K.relevance-z.relevance;if(z.language&&K.language){if(W(z.language).supersetOf===K.language)return 1;if(W(K.language).supersetOf===z.language)return-1}return 0}),[O,G]=C,Ke=O;return Ke.secondBest=G,Ke}function He(c,f,u){const v=f&&e[f]||u;c.classList.add("hljs"),c.classList.add(`language-${v}`)}function we(c){let f=null;const u=_(c);if(p(u))return;if(ve("before:highlightElement",{el:c,language:u}),c.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",c);return}if(c.children.length>0&&(l.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(c)),l.throwUnescapedHTML))throw new Qi("One of your code blocks includes unescaped HTML.",c.innerHTML);f=c;const v=f.textContent,C=u?T(v,{language:u,ignoreIllegals:!0}):ye(v);c.innerHTML=C.value,c.dataset.highlighted="yes",He(c,u,C.language),c.result={language:C.language,re:C.relevance,relevance:C.relevance},C.secondBest&&(c.secondBest={language:C.secondBest.language,relevance:C.secondBest.relevance}),ve("after:highlightElement",{el:c,result:C,text:v})}function qe(c){l=Jt(l,c)}const Ut=()=>{le(),ke("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Ae(){le(),ke("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Me=!1;function le(){if(document.readyState==="loading"){Me=!0;return}document.querySelectorAll(l.cssSelector).forEach(we)}function Ie(){Me&&le()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",Ie,!1);function me(c,f){let u=null;try{u=f(t)}catch(v){if(ue("Language definition for '{}' could not be registered.".replace("{}",c)),i)ue(v);else throw v;u=r}u.name||(u.name=c),n[c]=u,u.rawDefinition=f.bind(null,t),u.aliases&&Ge(u.aliases,{languageName:c})}function at(c){delete n[c];for(const f of Object.keys(e))e[f]===c&&delete e[f]}function Fe(){return Object.keys(n)}function W(c){return c=(c||"").toLowerCase(),n[c]||n[e[c]]}function Ge(c,{languageName:f}){typeof c=="string"&&(c=[c]),c.forEach(u=>{e[u.toLowerCase()]=f})}function Ve(c){const f=W(c);return f&&!f.disableAutodetect}function ct(c){c["before:highlightBlock"]&&!c["before:highlightElement"]&&(c["before:highlightElement"]=f=>{c["before:highlightBlock"](Object.assign({block:f.el},f))}),c["after:highlightBlock"]&&!c["after:highlightElement"]&&(c["after:highlightElement"]=f=>{c["after:highlightBlock"](Object.assign({block:f.el},f))})}function st(c){ct(c),o.push(c)}function lt(c){const f=o.indexOf(c);f!==-1&&o.splice(f,1)}function ve(c,f){const u=c;o.forEach(function(v){v[u]&&v[u](f)})}function We(c){return ke("10.7.0","highlightBlock will be removed entirely in v12.0"),ke("10.7.0","Please use highlightElement now."),we(c)}Object.assign(t,{highlight:T,highlightAuto:ye,highlightAll:le,highlightElement:we,highlightBlock:We,configure:qe,initHighlighting:Ut,initHighlightingOnLoad:Ae,registerLanguage:me,unregisterLanguage:at,listLanguages:Fe,getLanguage:W,registerAliases:Ge,autoDetection:Ve,inherit:Jt,addPlugin:st,removePlugin:lt}),t.debugMode=function(){i=!1},t.safeMode=function(){i=!0},t.versionString=Ji,t.regex={concat:ge,lookahead:Kn,either:Ot,optional:pi,anyNumberOfTimes:di};for(const c in Ze)typeof Ze[c]=="object"&&Vn(Ze[c]);return Object.assign(t,Ze),t},_e=oo({});_e.newInstance=()=>oo({});var tr=_e;_e.HighlightJS=_e;_e.default=_e;const io=zo(tr),en="[A-Za-z$_][0-9A-Za-z$_]*",nr=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],or=["true","false","null","undefined","NaN","Infinity"],ro=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],ao=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],co=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],ir=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],rr=[].concat(co,ro,ao);function ar(t){const n=t.regex,e=(f,{after:u})=>{const v="</"+f[0].slice(1);return f.input.indexOf(v,u)!==-1},o=en,i={begin:"<>",end:"</>"},a=/<[A-Za-z0-9\\._:-]+\s*\/>/,r={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(f,u)=>{const v=f[0].length+f.index,C=f.input[v];if(C==="<"||C===","){u.ignoreMatch();return}C===">"&&(e(f,{after:v})||u.ignoreMatch());let O;const G=f.input.substring(v);if(O=G.match(/^\s*=/)){u.ignoreMatch();return}if((O=G.match(/^\s+extends\s+/))&&O.index===0){u.ignoreMatch();return}}},l={$pattern:en,keyword:nr,literal:or,built_in:rr,"variable.language":ir},p="[0-9](_?[0-9])*",_=`\\.(${p})`,T="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",te={className:"number",variants:[{begin:`(\\b(${T})((${_})|\\.)?|(${_}))[eE][+-]?(${p})\\b`},{begin:`\\b(${T})\\b((${_})\\b|\\.)?|(${_})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},V={className:"subst",begin:"\\$\\{",end:"\\}",keywords:l,contains:[]},ye={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[t.BACKSLASH_ESCAPE,V],subLanguage:"xml"}},He={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[t.BACKSLASH_ESCAPE,V],subLanguage:"css"}},we={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[t.BACKSLASH_ESCAPE,V],subLanguage:"graphql"}},qe={className:"string",begin:"`",end:"`",contains:[t.BACKSLASH_ESCAPE,V]},Ae={className:"comment",variants:[t.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:o+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),t.C_BLOCK_COMMENT_MODE,t.C_LINE_COMMENT_MODE]},Me=[t.APOS_STRING_MODE,t.QUOTE_STRING_MODE,ye,He,we,qe,{match:/\$\d+/},te];V.contains=Me.concat({begin:/\{/,end:/\}/,keywords:l,contains:["self"].concat(Me)});const le=[].concat(Ae,V.contains),Ie=le.concat([{begin:/(\s*)\(/,end:/\)/,keywords:l,contains:["self"].concat(le)}]),me={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:l,contains:Ie},at={variants:[{match:[/class/,/\s+/,o,/\s+/,/extends/,/\s+/,n.concat(o,"(",n.concat(/\./,o),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,o],scope:{1:"keyword",3:"title.class"}}]},Fe={relevance:0,match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...ro,...ao]}},W={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},Ge={variants:[{match:[/function/,/\s+/,o,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[me],illegal:/%/},Ve={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function ct(f){return n.concat("(?!",f.join("|"),")")}const st={match:n.concat(/\b/,ct([...co,"super","import"].map(f=>`${f}\\s*\\(`)),o,n.lookahead(/\s*\(/)),className:"title.function",relevance:0},lt={begin:n.concat(/\./,n.lookahead(n.concat(o,/(?![0-9A-Za-z$_(])/))),end:o,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},ve={match:[/get|set/,/\s+/,o,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},me]},We="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+t.UNDERSCORE_IDENT_RE+")\\s*=>",c={match:[/const|var|let/,/\s+/,o,/\s*/,/=\s*/,/(async\s*)?/,n.lookahead(We)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[me]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:l,exports:{PARAMS_CONTAINS:Ie,CLASS_REFERENCE:Fe},illegal:/#(?![$_A-z])/,contains:[t.SHEBANG({label:"shebang",binary:"node",relevance:5}),W,t.APOS_STRING_MODE,t.QUOTE_STRING_MODE,ye,He,we,qe,Ae,{match:/\$\d+/},te,Fe,{className:"attr",begin:o+n.lookahead(":"),relevance:0},c,{begin:"("+t.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[Ae,t.REGEXP_MODE,{className:"function",begin:We,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:t.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:l,contains:Ie}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:i.begin,end:i.end},{match:a},{begin:r.begin,"on:begin":r.isTrulyOpeningTag,end:r.end}],subLanguage:"xml",contains:[{begin:r.begin,end:r.end,skip:!0,contains:["self"]}]}]},Ge,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+t.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[me,t.inherit(t.TITLE_MODE,{begin:o,className:"title.function"})]},{match:/\.\.\./,relevance:0},lt,{match:"\\$"+o,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[me]},st,Ve,at,ve,{match:/\$[(.]/}]}}io.registerLanguage("javascript",ar);var it,so;class Mt extends j{constructor(e){super(e);R(this,it);this.language="javascript"}render(){return d`
      <pre part="container"><code>${nn(this.code)}</code></pre>
      <slot @slotchange="${()=>s(this,it,so).call(this)}"></slot>
    `}}it=new WeakSet,so=function(){const o=this.shadowRoot.querySelector("slot").assignedNodes()[0].textContent;this.code=io.highlight(o,{language:this.language}).value},x(Mt,"styles",[B(si)]),x(Mt,"properties",{language:{type:String},code:{tyoe:String,state:!0}});customElements.define("code-block",Mt);const cr="::slotted([slot=demo]){aspect-ratio:var(--ratio-widescreen)}::slotted([slot=description]){padding-left:var(--size-2);color:var(--color-4);font-weight:var(--font-weight-3);font-size:var(--font-size-1);text-align:justify;border-left:3px solid var(--color-5)}[part=implementation-toggle]{display:flex;align-items:center;cursor:pointer}[part=implementation-toggle] i{margin-right:var(--size-1)}[part=implementation]{display:none;margin-bottom:var(--size-4);background-color:var(--color-10);border:2px solid var(--color-5);border-radius:var(--radius-1);box-shadow:var(--inner-shadow-4)}[part=implementation].active{display:block}[part=implementation-code]{padding-inline:var(--size-3)}[part=implementation-footer]{display:flex;align-items:center;justify-content:end;border-top:1px solid var(--color-6);padding-inline:var(--size-2)}[part=implementation-link]{padding:var(--size-2);font-size:var(--font-size-0)}.hidden{display:none}";var se,lo,mo,fo;class It extends j{constructor(){super(...arguments);R(this,se)}connectedCallback(){super.connectedCallback(),this.collapsed=!0,this.shadowRoot.addEventListener("slotchange",()=>{this.hasCodeExample=s(this,se,lo).call(this,"code")})}updated(e){super.updated(e),e.has("collapsed")&&!this.collapsed&&this.shadowRoot.querySelector('[part="implementation"]').classList.add("active")}render(){return d`
    ...
    `}}se=new WeakSet,lo=function(e){return this.shadowRoot.querySelector(`slot[name="${e}"]`).assignedNodes().length>0},mo=function(e){e.target.classList.toggle("active",!e.target.classList.contains("fade-out-shrink")),e.target.classList.remove("fade-in-grow","fade-out-shrink")},fo=function(){return{"fade-in-grow":this.collapsed===!1,"fade-out-shrink":this.collapsed===!0}},x(It,"styles",[q,F,B(cr)]),x(It,"properties",{collapsed:{type:Boolean},hasCodeExample:{type:Boolean,state:!0},exampleLanguage:{type:String},href:{type:String}});customElements.define("showcase-component",It);const sr="[part=showcase-link]{display:flex;flex-direction:column;gap:var(--size-2);justify-content:center;min-height:var(--size-9);margin:0;color:var(--color-0);font-weight:var(--font-weight-6);font-size:var(--size-3);text-align:center;text-decoration:none;background-color:var(--color-9);border:1px solid var(--color-10);border-radius:var(--radius-2);transition:background-color .4s,border-color .4s;padding-inline:var(--size-3)}[part=showcase-link]:hover{text-decoration:none;background-color:var(--color-8);border-color:var(--color-9)}div{margin-top:var(--size-7)}div:last-child{margin-bottom:var(--size-7)}a{font-size:inherit}",lr=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
...
`;function yr(t){const n=t.replace(/^[\r\n]+|[\r\n]+$/g,""),o=n.split(`
`)[0].match(/^ */)[0].length,i=new RegExp(`^ {${o}}`,"gm");return n.replace(i,"")}const wr=new DOMParser;function ee(t,n="[data-implementation]"){return yr(wr.parseFromString(t,"text/html").querySelector(n).textContent)}const vr=ee(lr),kr=ee(mr),xr=ee(fr),Sr=ee(br),Er=ee(dr),Rr=ee(pr),Cr=ee(hr),_r=ee(ur),Tr=ee(gr);var I,po,ho,uo,go,yo,wo,vo,ko,xo;class bo extends j{constructor(){super(...arguments);R(this,I)}render(){return d`
    ...
    `},Eo=function(){return d`
      ...
      </nav>`},x(Dt,"properties",{debug:{type:Boolean,state:!0}}),x(Dt,"styles",[q,B(Lr)]);customElements.define("demo-header",Dt);class Ro extends j{constructor(){super(),this.route=w.currentRoute,w.addEventListener("routechanged",({detail:{route:n}})=>{var e;(e=this.route)==null||e.destroy(),this.route=n})}render(){return nn(`<${this.route.component}></${this.route.component}>`)}}x(Ro,"properties",{route:{state:!0}});customElements.define("route-outlet",Ro);const et=Se.loadPreferences();P.host=et.dataProviderHost;w.start({defaultPath:"examples"});w.queryParams.debug?(et.debug=w.queryParams.debug==="true",Se.savePreferences(et)):et.debug&&w.updateState({debug:"true"});
//# sourceMappingURL=index-dbJf0Erk.js.map
