import{i as M,t as Fe,a as st,r as Q,b as u,p as me,c as S,e as En,d as kn,f as Cn,E as Rn,g as Tn,o as Et}from"./core-demo-header-component-CWQBvAYW.js";const _n="[part=container]{block-size:480px;aspect-ratio:var(--ratio-widescreen);padding:0;overflow:visible;background-color:var(--color-12)}[part=close-btn]{position:absolute;top:calc(var(--size-3) * -1);right:0;z-index:2;width:var(--size-7);height:var(--size-7);font-size:var(--size-4);text-align:center;background:var(--gray-6);border-radius:var(--radius-round)}";class Ln extends M{static properties={open:{type:Boolean,reflect:!0}};static styles=[Fe,st,Q(_n)];#t;constructor(){super(),this.open=!1}updated(e){super.updated(e),e.has("open")&&(this.open?(this.#t.showModal(),this.#t.classList.toggle("slide-up-fade-in",!0)):this.#t.close())}firstUpdated(e){super.firstUpdated(e),this.#t=this.shadowRoot.querySelector("dialog")}#e(){this.dispatchEvent(new CustomEvent("close"))}#n(e){this.#t===e.target&&(this.open=!1)}render(){return u`
    ...
    `}}customElements.define("demo-dialog",Ln);class ue{static loadPreferences(){return JSON.parse(localStorage.getItem("preferences"))||{}}static savePreferences(e){localStorage.setItem("preferences",JSON.stringify(e))}}const it="il.srgssr.ch",J={vector:"srgplay"},An={includeAggregations:!1,includeSuggestions:!1,sortBy:"default",sortDir:"desc",pageSize:50,...J},Pn={onlyActiveShows:!0,...J},re=({title:s,urn:e,mediaType:n,date:i,duration:l})=>({title:s,urn:e,mediaType:n,date:i,duration:l});class In{#t;constructor(e=it){this.host=e}get host(){return this.#t}set host(e){this.#t=e||it}async search(e,n,i=void 0){const l=await this.#e(`/${e.toLowerCase()}/searchResultMediaList`,{...An,q:n},i),f=x=>x.searchResultMediaList.map(re);return{results:f(l),next:l.next?this.#n(l.next,f):void 0}}async topics(e,n="tv"){return(await this.#e(`/${e.toLowerCase()}/topicList/${n}`)).topicList.map(({title:l,urn:f})=>({title:l,urn:f}))}async latestByTopic(e,n=30){const i=await this.#e(`/mediaList/latest/byTopicUrn/${e}`,{pageSize:n}),l=f=>f.mediaList.map(re);return{results:l(i),next:i.next?this.#n(i.next,l):void 0}}async shows(e,n="unlimited",i="tv"){return(await this.#e(`/${e.toLowerCase()}/showList/${i}/alphabetical`,{...Pn,pageSize:n})).showList.map(({title:f,urn:x})=>({title:f,urn:x}))}async latestByShow(e,n=30){const i=await this.#e(`/episodeComposition/latestByShow/byUrn/${e}`,{...J,pageSize:n}),l=f=>f.episodeList.map(({mediaList:x})=>x[0]).map(re);return{results:l(i),next:i.next?this.#n(i.next,l):void 0}}async editorial(e,n=30){const i=await this.#e(`/${e.toLowerCase()}/mediaList/video/editorial`,{...J,pageSize:n}),l=f=>f.mediaList.map(re);return{results:l(i),next:i.next?this.#n(i.next,l):void 0}}async livestreams(e,n="video"){return(await this.#e(`/${e.toLowerCase()}/mediaList/${n}/livestreams`)).mediaList.map(re)}async scheduledLivestream(e,n=10){const i=await this.#e(`/${e.toLowerCase()}/mediaList/video/scheduledLivestreams`,{...J,pageSize:n}),l=f=>f.mediaList.map(re);return{results:l(i),next:i.next?this.#n(i.next,l):void 0}}async livecenter(e,n=10){const i=await this.#e(`/${e.toLowerCase()}/mediaList/video/scheduledLivestreams/livecenter`,{...J,pageSize:n}),l=f=>f.mediaList.map(re);return{results:l(i),next:i.next?this.#n(i.next,l):void 0}}async channels(e,n="radio"){return(await this.#e(`/${e.toLowerCase()}/channelList/${n}`)).channelList.map(({title:l,id:f})=>({title:l,id:f}))}async radioShowByChannel(e,n,i="unlimited"){return(await this.#e(`/${e.toLowerCase()}/showList/radio/alphabeticalByChannel/${n}`,{...J,pageSize:i})).showList.map(({title:f,urn:x})=>({title:f,urn:x}))}async#e(e,n=J,i=void 0){const l=new URLSearchParams(n).toString(),f=`https://${this.host}/integrationlayer/2.0/${e.replace(/^\/+/,"")}?${l}`;return fetch(f,{signal:i}).then(x=>x.ok?x.json():Promise.reject(x)).catch(x=>Promise.reject(x))}#n(e,n){return async(i=void 0)=>{const l=await fetch(e,{signal:i}).then(x=>x.ok?x.json():Promise.reject(x)).catch(x=>Promise.reject(x));return{results:n(l),next:this.#n(l.next,n)}}}}const $=new In,kt="demo-player",Dn={restoreEl:!0},Mn=s=>({muted:s.muted??!0,autoplay:s.autoplay??!1,debug:s.debug??!1,srgOptions:{dataProviderHost:s.dataProviderHost??it}}),Nn=(s={})=>(window.player=new me(kt,{...Dn,...Mn(ue.loadPreferences()),...s}),window.player),$n=()=>{me.getPlayer(kt).dispose(),window.player=null};window.pillarbox=me;const Ct=document.querySelector("demo-dialog"),Rt=s=>{const e=Object.keys(s??{})[0];return e?{vendor:e,...e==="com.apple.fps.1_0"?s[e]:{licenseUri:s[e]}}:{}},On=s=>{if(!s.vendor)return;const{certificateUri:e,licenseUri:n}=s;return s.vendor==="com.apple.fps.1_0"?{[s.vendor]:{certificateUri:e,licenseUri:n}}:{[s.vendor]:n}},jn=({src:s,type:e,keySystems:n})=>new URLSearchParams({src:s,type:e,...Rt(n)}).toString();Ct.addEventListener("close",()=>{$n(),S.updateState({},["src","type","vendor","certificateUri","licenseUri"])});const Tt=s=>{if(window.player)return;const e=s.detail.queryParams;if("src"in e){const{src:n,type:i}=e,l=On(e);_t({src:n,type:i,keySystems:l})}};S.addEventListener("routechanged",Tt);S.addEventListener("queryparams",Tt);const _t=({src:s,type:e,keySystems:n,playerOptions:i},l=!0)=>{const f=Nn(i??{});return Ct.open=!0,f.src({src:s,type:e,keySystems:n}),l&&S.updateState({src:s,...e?{type:e}:{},...Rt(n)}),f};const He=En(class extends kn{constructor(s){if(super(s),s.type!==Cn.ATTRIBUTE||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){if(this.st===void 0){this.st=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}const n=s.element.classList;for(const i of this.st)i in e||(n.remove(i),this.st.delete(i));for(const i in e){const l=!!e[i];l===this.st.has(i)||this.nt?.has(i)||(l?(n.add(i),this.st.add(i)):(n.remove(i),this.st.delete(i)))}return Rn}});class Un extends M{static properties={src:{type:String},drmSettings:{type:Object},drmSettingsShown:{state:!0,type:Boolean}};createRenderRoot(){return this}constructor(){super(),this.src="",this.#t()}#t(){this.drmSettings={vendor:"",certificateUri:"",licenseUri:""}}#e(){try{return new URL(this.src).searchParams.get("urn")??this.src}catch{return this.src}}#n(){const e=this.#e()?.trim(),n=e.startsWith("urn:")?"srgssr/urn":void 0,i=this.#s;this.dispatchEvent(new CustomEvent("submit-media",{detail:{src:e,type:n,keySystems:i}}))}#i(e){this.src=e.target.value,e.key==="Enter"&&this.src&&this.#n()}get#s(){if(this.drmSettings?.vendor)return this.#a()}#a(){const e=this.drmSettings.certificateUri?.trim(),n=this.drmSettings.licenseUri?.trim();return this.drmSettings.vendor==="com.apple.fps.1_0"?{[this.drmSettings.vendor]:{certificateUri:e,licenseUri:n}}:{[this.drmSettings.vendor]:n}}render(){const e={spin:this.drmSettingsShown===!0,"spin-back":this.drmSettingsShown===!1};return u`
...
`,type:"application/x-mpegURL"},{title:"Multiple subtitles and audio tracks",description:"On some devices codec may crash",src:"https://bitmovin-a.akamaihd.net/content/sintel/hls/playlist.m3u8",type:"application/x-mpegURL"},{title:"4K, HEVC",src:"https://cdn.bitmovin.com/content/encoding_test_dash_hls/4k/hls/4k_profile/master.m3u8",type:"application/x-mpegURL"},{title:"VoD, single audio track",src:"https://bitmovin-a.akamaihd.net/content/MI201109210084_1/m3u8s/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.m3u8",type:"application/x-mpegURL"},{title:"AES-128",src:"https://bitmovin-a.akamaihd.net/content/art-of-motion_drm/m3u8s/11331.m3u8",type:"application/x-mpegURL"},{title:"HLS - Fragmented MP4",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8",type:"application/x-mpegURL"},{title:"HLS - Alternate audio language",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-lang.ism/.m3u8",type:"application/x-mpegURL"},{title:"HLS - Audio only",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-lang.ism/.m3u8?filter=(type!=%22video%22)",type:"application/x-mpegURL"},{title:"HLS - Trickplay",src:"https://demo.unified-streaming.com/k8s/features/stable/no-handler-origin/tears-of-steel/tears-of-steel-trickplay.m3u8",type:"application/x-mpegURL"},{title:"Limiting bandwidth use",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8?max_bitrate=800000",type:"application/x-mpegURL"},{title:"Dynamic Track Selection",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8?filter=%28type%3D%3D%22audio%22%26%26systemBitrate%3C100000%29%7C%7C%28type%3D%3D%22video%22%26%26systemBitrate%3C1024000%29",type:"application/x-mpegURL"},{title:"Pure live",src:"https://demo.unified-streaming.com/k8s/live/stable/live.isml/.m3u8",type:"application/x-mpegURL"},{title:"Timeshift (5 minutes)",src:"https://demo.unified-streaming.com/k8s/live/stable/live.isml/.m3u8?time_shift=300",type:"application/x-mpegURL"},{title:"Live audio",src:"https://demo.unified-streaming.com/k8s/live/stable/live.isml/.m3u8?filter=(type!=%22video%22)",type:"application/x-mpegURL"},{title:"Pure live (scte35)",src:"https://demo.unified-streaming.com/k8s/live/stable/scte35.isml/.m3u8",type:"application/x-mpegURL"},{title:"fMP4, clear",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-fmp4.ism/.m3u8",type:"application/x-mpegURL"},{title:"fMP4, HEVC 4K",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-hevc.ism/.m3u8",type:"application/x-mpegURL"},{title:"Test1",description:"Forced subtitles",src:"https://prd.vod-srgssr.ch/origin/1053457/fr/master.m3u8?complexSubs=true",type:"application/x-mpegURL"}],DASH:[{title:"VoD - Dash (H264)",src:"https://storage.googleapis.com/wvmedia/clear/h264/tears/tears.mpd",type:"application/dash+xml"},{title:"VoD - Dash Widewine cenc (H264)",src:"https://storage.googleapis.com/wvmedia/cenc/h264/tears/tears.mpd",type:"application/dash+xml",keySystems:{"com.widevine.alpha":"https://proxy.uat.widevine.com/proxy?video_id=2015_tears&provider=widevine_test"}},{title:"VoD - Dash (H265)",src:"https://storage.googleapis.com/wvmedia/clear/hevc/tears/tears.mpd",type:"application/dash+xml"},{title:"VoD - Dash widewine cenc (H265)",src:"https://storage.googleapis.com/wvmedia/cenc/hevc/tears/tears.mpd",type:"application/dash+xml",keySystems:{"com.widevine.alpha":"https://proxy.uat.widevine.com/proxy?video_id=2015_tears&provider=widevine_test"}},{title:"VoD - Dash - MP4",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.mp4/.mpd",type:"application/dash+xml"},{title:"Dash - Fragmented MP4",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.mpd",type:"application/dash+xml"},{title:"Dash - TrickPlay",src:"https://demo.unified-streaming.com/k8s/features/stable/no-handler-origin/tears-of-steel/tears-of-steel-trickplay.mpd",type:"application/dash+xml"},{title:"Dash - Tiled thumbnails (live/timeline)",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-tiled-thumbnails-timeline.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Accessibility - hard of hearing",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-hoh-subs.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Single - fragmented TTML",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-en.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Multiple - RFC 5646 language tags",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-rfc5646.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Multiple - fragmented TTML",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-ttml.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Audio only",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-lang.ism/.mpd?filter=(type!=%22video%22)",type:"application/dash+xml"},{title:"Dash - Multiple audio codecs",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-codec.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Alternate audio language",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-lang.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Accessibility - audio description",src:"https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-desc-aud.ism/.mpd",type:"application/dash+xml"},{title:"Dash - Pure live",src:"https://demo.unified-streaming.com/k8s/live/stable/live.isml/.mpd",type:"application/dash+xml"},{title:"Dash - Timeshift (5 minutes)",src:"https://demo.unified-streaming.com/k8s/live/stable/live.isml/.mpd?time_shift=300",type:"application/dash+xml"},{title:"Dash - DVB DASH low latency",src:"https://demo.unified-streaming.com/k8s/live/stable/live-low-latency.isml/.mpd",type:"application/dash+xml"}],MP4:[{title:"VOD - MP4",description:"The dig",src:"https://media.swissinfo.ch/media/video/dddaff93-c2cd-4b6e-bdad-55f75a519480/rendition/154a844b-de1d-4854-93c1-5c61cd07e98c.mp4",type:"video/mp4"},{title:"AVC Progressive",src:"https://bitmovin-a.akamaihd.net/content/MI201109210084_1/MI201109210084_mpeg-4_hd_high_1080p25_10mbits.mp4",type:"video/mp4"}],AOD:[{title:"Audio HLS",description:"Content with PTS rollover",src:"https://cdn.rts.ch/audio-sample/playlist.m3u8",type:"application/x-mpegURL"}]};function*oe(s,e){if(s!==void 0){let n=0;for(const i of s)yield e(i,n++)}}function q(s,e,n){return s?e(s):n?.(s)}class zn extends M{createRenderRoot(){return this}render(){return u`
    ...
    `}async#l(e){const n=this.abortFetch();await e.fetchNext(n),this.#i()}#c(e,n){const i=this.level[0],l=this.level.length===1&&i.next;return u`
      ${oe(e,(f,x)=>u`
        ${q(f.mediaType,()=>this.#a(f,x),()=>this.#o(f,n,x))}
      `)}
      ${q(l,()=>u`
    ...
    `}}customElements.define("lists-page",Jn);S.addRoute("lists","lists-page");const Qn="[part=search-bar-container]{display:flex;align-items:center;margin:0 0 var(--size-1) 0;padding:0 var(--size-2);background-color:var(--color-8);border-radius:var(--radius-2)}[part=search-bar-container] input{width:90%}[part=search-bar-container] button{display:flex;align-items:center;background-color:var(--color-8);border:0}",tt="rsi";class ei extends M{static properties={bu:{type:String},query:{type:String}};static styles=[Fe,Q(Qn)];constructor(){super(),this.bu=tt,this.query=""}#t(){this.query=this.renderRoot.querySelector("input").value}#e(e){this.bu=e.target.value}updated(e){if(super.updated(e),["bu","query"].some(n=>e.has(n))){const n=this.query??"",i=this.bu??tt;this.dispatchEvent(new CustomEvent("change",{detail:{query:n,bu:i}}))}}#n(){this.query="",this.renderRoot.querySelector("input").value=""}render(){return u`
    ...
    `}#o(){const e={empty:this.results==null,"no-results":this.results&&this.results.length===0,"material-icons":!this.results||this.results.length===0};return u`
      <section class="results-container fade-in ${He(e)}"
        ...
        ${oe(this.results??[],this.#r.bind(this))}
        ${q(this.nextPage,()=>u`
          <intersection-observer
    ...
    `}}customElements.define("settings-page",si);S.addRoute("settings","settings-page");const ai="@media screen and (prefers-color-scheme:dark){pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs{color:#adbac7;background:#22272e}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:#f47067}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#dcbdfb}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-variable,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id{color:#6cb6ff}.hljs-regexp,.hljs-string,.hljs-meta .hljs-string{color:#96d0ff}.hljs-built_in,.hljs-symbol{color:#f69d50}.hljs-comment,.hljs-code,.hljs-formula{color:#768390}.hljs-name,.hljs-quote,.hljs-selector-tag,.hljs-selector-pseudo{color:#8ddb8c}.hljs-subst{color:#adbac7}.hljs-section{color:#316dca;font-weight:700}.hljs-bullet{color:#eac55f}.hljs-emphasis{color:#adbac7;font-style:italic}.hljs-strong{color:#adbac7;font-weight:700}.hljs-addition{color:#b4f1b4;background-color:#1b4721}.hljs-deletion{color:#ffd8d3;background-color:#78191b}}@media screen and (prefers-color-scheme:light){pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs{color:#24292e;background:#fff}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:#d73a49}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#6f42c1}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-variable,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id{color:#005cc5}.hljs-regexp,.hljs-string,.hljs-meta .hljs-string{color:#032f62}.hljs-built_in,.hljs-symbol{color:#e36209}.hljs-comment,.hljs-code,.hljs-formula{color:#6a737d}.hljs-name,.hljs-quote,.hljs-selector-tag,.hljs-selector-pseudo{color:#22863a}.hljs-subst{color:#24292e}.hljs-section{color:#005cc5;font-weight:700}.hljs-bullet{color:#735c0f}.hljs-emphasis{color:#24292e;font-style:italic}.hljs-strong{color:#24292e;font-weight:700}.hljs-addition{color:#22863a;background-color:#f0fff4}.hljs-deletion{color:#b31d28;background-color:#ffeef0}}[part=container]{overflow-x:auto;font-size:var(--font-size-0)}slot{display:none}";var nt,xt;function ri(){if(xt)return nt;xt=1;function s(t){return t instanceof Map?t.clear=t.delete=t.set=function(){throw new Error("map is read-only")}:t instanceof Set&&(t.add=t.clear=t.delete=function(){throw new Error("set is read-only")}),Object.freeze(t),Object.getOwnPropertyNames(t).forEach(a=>{const o=t[a],b=typeof o;(b==="object"||b==="function")&&!Object.isFrozen(o)&&s(o)}),t}class e{constructor(a){a.data===void 0&&(a.data={}),this.data=a.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function n(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function i(t,...a){const o=Object.create(null);for(const b in t)o[b]=t[b];return a.forEach(function(b){for(const R in b)o[R]=b[R]}),o}const l="</span>",f=t=>!!t.scope,x=(t,{prefix:a})=>{if(t.startsWith("language:"))return t.replace("language:","language-");if(t.includes(".")){const o=t.split(".");return[`${a}${o.shift()}`,...o.map((b,R)=>`${b}${"_".repeat(R+1)}`)].join(" ")}return`${a}${t}`};class U{constructor(a,o){this.buffer="",this.classPrefix=o.classPrefix,a.walk(this)}addText(a){this.buffer+=n(a)}openNode(a){if(!f(a))return;const o=x(a.scope,{prefix:this.classPrefix});this.span(o)}closeNode(a){f(a)&&(this.buffer+=l)}value(){return this.buffer}span(a){this.buffer+=`<span class="${a}">`}}const ge=(t={})=>{const a={children:[]};return Object.assign(a,t),a};class W{constructor(){this.rootNode=ge(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(a){this.top.children.push(a)}openNode(a){const o=ge({scope:a});this.add(o),this.stack.push(o)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(a){return this.constructor._walk(a,this.rootNode)}static _walk(a,o){return typeof o=="string"?a.addText(o):o.children&&(a.openNode(o),o.children.forEach(b=>this._walk(a,b)),a.closeNode(o)),a}static _collapse(a){typeof a!="string"&&a.children&&(a.children.every(o=>typeof o=="string")?a.children=[a.children.join("")]:a.children.forEach(o=>{W._collapse(o)}))}}class we extends W{constructor(a){super(),this.options=a}addText(a){a!==""&&this.add(a)}startScope(a){this.openNode(a)}endScope(){this.closeNode()}__addSublanguage(a,o){const b=a.root;o&&(b.scope=`language:${o}`),this.add(b)}toHTML(){return new U(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function X(t){return t?typeof t=="string"?t:t.source:null}function V(t){return H("(?=",t,")")}function xe(t){return H("(?:",t,")*")}function Se(t){return H("(?:",t,")?")}function H(...t){return t.map(o=>X(o)).join("")}function Ee(t){const a=t[t.length-1];return typeof a=="object"&&a.constructor===Object?(t.splice(t.length-1,1),a):{}}function ke(...t){return"("+(Ee(t).capture?"":"?:")+t.map(b=>X(b)).join("|")+")"}function le(t){return new RegExp(t.toString()+"|").exec("").length-1}function Ce(t,a){const o=t&&t.exec(a);return o&&o.index===0}const Re=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function ee(t,{joinWith:a}){let o=0;return t.map(b=>{o+=1;const R=o;let T=X(b),p="";for(;T.length>0;){const d=Re.exec(T);if(!d){p+=T;break}p+=T.substring(0,d.index),T=T.substring(d.index+d[0].length),d[0][0]==="\\"&&d[1]?p+="\\"+String(Number(d[1])+R):(p+=d[0],d[0]==="("&&o++)}return p}).map(b=>`(${b})`).join(a)}const te=/\b\B/,Te="[a-zA-Z]\\w*",ce="[a-zA-Z_]\\w*",_e="\\b\\d+(\\.\\d+)?",Le="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",Ae="\\b(0b[01]+)",ze="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",qe=(t={})=>{const a=/^#![ ]*\//;return t.binary&&(t.begin=H(a,/.*\b/,t.binary,/\b.*/)),i({scope:"meta",begin:a,end:/$/,relevance:0,"on:begin":(o,b)=>{o.index!==0&&b.ignoreMatch()}},t)},ne={begin:"\\\\[\\s\\S]",relevance:0},Ve={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[ne]},Pe={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[ne]},Ge={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},I=function(t,a,o={}){const b=i({scope:"comment",begin:t,end:a,contains:[]},o);b.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const R=ke("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return b.contains.push({begin:H(/[ ]+/,"(",R,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),b},K=I("//","$"),ie=I("/\\*","\\*/"),de=I("#","$"),fe={scope:"number",begin:_e,relevance:0},Ie={scope:"number",begin:Le,relevance:0},Dt={scope:"number",begin:Ae,relevance:0},Mt={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[ne,{begin:/\[/,end:/\]/,relevance:0,contains:[ne]}]},Nt={scope:"title",begin:Te,relevance:0},$t={scope:"title",begin:ce,relevance:0},Ot={begin:"\\.\\s*"+ce,relevance:0};var De=Object.freeze({__proto__:null,APOS_STRING_MODE:Ve,BACKSLASH_ESCAPE:ne,BINARY_NUMBER_MODE:Dt,BINARY_NUMBER_RE:Ae,COMMENT:I,C_BLOCK_COMMENT_MODE:ie,C_LINE_COMMENT_MODE:K,C_NUMBER_MODE:Ie,C_NUMBER_RE:Le,END_SAME_AS_BEGIN:function(t){return Object.assign(t,{"on:begin":(a,o)=>{o.data._beginMatch=a[1]},"on:end":(a,o)=>{o.data._beginMatch!==a[1]&&o.ignoreMatch()}})},HASH_COMMENT_MODE:de,IDENT_RE:Te,MATCH_NOTHING_RE:te,METHOD_GUARD:Ot,NUMBER_MODE:fe,NUMBER_RE:_e,PHRASAL_WORDS_MODE:Ge,QUOTE_STRING_MODE:Pe,REGEXP_MODE:Mt,RE_STARTERS_RE:ze,SHEBANG:qe,TITLE_MODE:Nt,UNDERSCORE_IDENT_RE:ce,UNDERSCORE_TITLE_MODE:$t});function jt(t,a){t.input[t.index-1]==="."&&a.ignoreMatch()}function Ut(t,a){t.className!==void 0&&(t.scope=t.className,delete t.className)}function Bt(t,a){a&&t.beginKeywords&&(t.begin="\\b("+t.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",t.__beforeBegin=jt,t.keywords=t.keywords||t.beginKeywords,delete t.beginKeywords,t.relevance===void 0&&(t.relevance=0))}function Ht(t,a){Array.isArray(t.illegal)&&(t.illegal=ke(...t.illegal))}function Ft(t,a){if(t.match){if(t.begin||t.end)throw new Error("begin & end are not supported with match");t.begin=t.match,delete t.match}}function zt(t,a){t.relevance===void 0&&(t.relevance=1)}const qt=(t,a)=>{if(!t.beforeMatch)return;if(t.starts)throw new Error("beforeMatch cannot be used with starts");const o=Object.assign({},t);Object.keys(t).forEach(b=>{delete t[b]}),t.keywords=o.keywords,t.begin=H(o.beforeMatch,V(o.begin)),t.starts={relevance:0,contains:[Object.assign(o,{endsParent:!0})]},t.relevance=0,delete o.beforeMatch},Vt=["of","and","for","in","not","or","if","then","parent","list","value"],Gt="keyword";function at(t,a,o=Gt){const b=Object.create(null);return typeof t=="string"?R(o,t.split(" ")):Array.isArray(t)?R(o,t):Object.keys(t).forEach(function(T){Object.assign(b,at(t[T],a,T))}),b;function R(T,p){a&&(p=p.map(d=>d.toLowerCase())),p.forEach(function(d){const g=d.split("|");b[g[0]]=[T,Wt(g[0],g[1])]})}}function Wt(t,a){return a?Number(a):Xt(t)?0:1}function Xt(t){return Vt.includes(t.toLowerCase())}const rt={},se=t=>{console.error(t)},ot=(t,...a)=>{console.log(`WARN: ${t}`,...a)},pe=(t,a)=>{rt[`${t}/${a}`]||(console.log(`Deprecated as of ${t}. ${a}`),rt[`${t}/${a}`]=!0)},Me=new Error;function lt(t,a,{key:o}){let b=0;const R=t[o],T={},p={};for(let d=1;d<=a.length;d++)p[d+b]=R[d],T[d+b]=!0,b+=le(a[d-1]);t[o]=p,t[o]._emit=T,t[o]._multi=!0}function Kt(t){if(Array.isArray(t.begin)){if(t.skip||t.excludeBegin||t.returnBegin)throw se("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Me;if(typeof t.beginScope!="object"||t.beginScope===null)throw se("beginScope must be object"),Me;lt(t,t.begin,{key:"beginScope"}),t.begin=ee(t.begin,{joinWith:""})}}function Yt(t){if(Array.isArray(t.end)){if(t.skip||t.excludeEnd||t.returnEnd)throw se("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Me;if(typeof t.endScope!="object"||t.endScope===null)throw se("endScope must be object"),Me;lt(t,t.end,{key:"endScope"}),t.end=ee(t.end,{joinWith:""})}}function Zt(t){t.scope&&typeof t.scope=="object"&&t.scope!==null&&(t.beginScope=t.scope,delete t.scope)}function Jt(t){Zt(t),typeof t.beginScope=="string"&&(t.beginScope={_wrap:t.beginScope}),typeof t.endScope=="string"&&(t.endScope={_wrap:t.endScope}),Kt(t),Yt(t)}function Qt(t){function a(p,d){return new RegExp(X(p),"m"+(t.case_insensitive?"i":"")+(t.unicodeRegex?"u":"")+(d?"g":""))}class o{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(d,g){g.position=this.position++,this.matchIndexes[this.matchAt]=g,this.regexes.push([g,d]),this.matchAt+=le(d)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const d=this.regexes.map(g=>g[1]);this.matcherRe=a(ee(d,{joinWith:"|"}),!0),this.lastIndex=0}exec(d){this.matcherRe.lastIndex=this.lastIndex;const g=this.matcherRe.exec(d);if(!g)return null;const P=g.findIndex((be,Xe)=>Xe>0&&be!==void 0),_=this.matchIndexes[P];return g.splice(0,P),Object.assign(g,_)}}class b{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(d){if(this.multiRegexes[d])return this.multiRegexes[d];const g=new o;return this.rules.slice(d).forEach(([P,_])=>g.addRule(P,_)),g.compile(),this.multiRegexes[d]=g,g}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(d,g){this.rules.push([d,g]),g.type==="begin"&&this.count++}exec(d){const g=this.getMatcher(this.regexIndex);g.lastIndex=this.lastIndex;let P=g.exec(d);if(this.resumingScanAtSamePosition()&&!(P&&P.index===this.lastIndex)){const _=this.getMatcher(0);_.lastIndex=this.lastIndex+1,P=_.exec(d)}return P&&(this.regexIndex+=P.position+1,this.regexIndex===this.count&&this.considerAll()),P}}function R(p){const d=new b;return p.contains.forEach(g=>d.addRule(g.begin,{rule:g,type:"begin"})),p.terminatorEnd&&d.addRule(p.terminatorEnd,{type:"end"}),p.illegal&&d.addRule(p.illegal,{type:"illegal"}),d}function T(p,d){const g=p;if(p.isCompiled)return g;[Ut,Ft,Jt,qt].forEach(_=>_(p,d)),t.compilerExtensions.forEach(_=>_(p,d)),p.__beforeBegin=null,[Bt,Ht,zt].forEach(_=>_(p,d)),p.isCompiled=!0;let P=null;return typeof p.keywords=="object"&&p.keywords.$pattern&&(p.keywords=Object.assign({},p.keywords),P=p.keywords.$pattern,delete p.keywords.$pattern),P=P||/\w+/,p.keywords&&(p.keywords=at(p.keywords,t.case_insensitive)),g.keywordPatternRe=a(P,!0),d&&(p.begin||(p.begin=/\B|\b/),g.beginRe=a(g.begin),!p.end&&!p.endsWithParent&&(p.end=/\B|\b/),p.end&&(g.endRe=a(g.end)),g.terminatorEnd=X(g.end)||"",p.endsWithParent&&d.terminatorEnd&&(g.terminatorEnd+=(p.end?"|":"")+d.terminatorEnd)),p.illegal&&(g.illegalRe=a(p.illegal)),p.contains||(p.contains=[]),p.contains=[].concat(...p.contains.map(function(_){return en(_==="self"?p:_)})),p.contains.forEach(function(_){T(_,g)}),p.starts&&T(p.starts,d),g.matcher=R(g),g}if(t.compilerExtensions||(t.compilerExtensions=[]),t.contains&&t.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return t.classNameAliases=i(t.classNameAliases||{}),T(t)}function ct(t){return t?t.endsWithParent||ct(t.starts):!1}function en(t){return t.variants&&!t.cachedVariants&&(t.cachedVariants=t.variants.map(function(a){return i(t,{variants:null},a)})),t.cachedVariants?t.cachedVariants:ct(t)?i(t,{starts:t.starts?i(t.starts):null}):Object.isFrozen(t)?i(t):t}var tn="11.11.1";class nn extends Error{constructor(a,o){super(a),this.name="HTMLInjectionError",this.html=o}}const We=n,dt=i,pt=Symbol("nomatch"),sn=7,ht=function(t){const a=Object.create(null),o=Object.create(null),b=[];let R=!0;const T="Could not find the language '{}', did you forget to load/include a language module?",p={disableAutodetect:!0,name:"Plain text",contains:[]};let d={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:we};function g(r){return d.noHighlightRe.test(r)}function P(r){let m=r.className+" ";m+=r.parentNode?r.parentNode.className:"";const w=d.languageDetectRe.exec(m);if(w){const k=Y(w[1]);return k||(ot(T.replace("{}",w[1])),ot("Falling back to no-highlight mode for this block.",r)),k?w[1]:"no-highlight"}return m.split(/\s+/).find(k=>g(k)||Y(k))}function _(r,m,w){let k="",A="";typeof m=="object"?(k=r,w=m.ignoreIllegals,A=m.language):(pe("10.7.0","highlight(lang, code, ...args) has been deprecated."),pe("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),A=r,k=m),w===void 0&&(w=!0);const B={code:k,language:A};$e("before:highlight",B);const Z=B.result?B.result:be(B.language,B.code,w);return Z.code=B.code,$e("after:highlight",Z),Z}function be(r,m,w,k){const A=Object.create(null);function B(c,h){return c.keywords[h]}function Z(){if(!y.keywords){D.addText(C);return}let c=0;y.keywordPatternRe.lastIndex=0;let h=y.keywordPatternRe.exec(C),v="";for(;h;){v+=C.substring(c,h.index);const E=z.case_insensitive?h[0].toLowerCase():h[0],N=B(y,E);if(N){const[G,xn]=N;if(D.addText(v),v="",A[E]=(A[E]||0)+1,A[E]<=sn&&(Ue+=xn),G.startsWith("_"))v+=h[0];else{const Sn=z.classNameAliases[G]||G;F(h[0],Sn)}}else v+=h[0];c=y.keywordPatternRe.lastIndex,h=y.keywordPatternRe.exec(C)}v+=C.substring(c),D.addText(v)}function Oe(){if(C==="")return;let c=null;if(typeof y.subLanguage=="string"){if(!a[y.subLanguage]){D.addText(C);return}c=be(y.subLanguage,C,!0,wt[y.subLanguage]),wt[y.subLanguage]=c._top}else c=Ke(C,y.subLanguage.length?y.subLanguage:null);y.relevance>0&&(Ue+=c.relevance),D.__addSublanguage(c._emitter,c.language)}function j(){y.subLanguage!=null?Oe():Z(),C=""}function F(c,h){c!==""&&(D.startScope(h),D.addText(c),D.endScope())}function ft(c,h){let v=1;const E=h.length-1;for(;v<=E;){if(!c._emit[v]){v++;continue}const N=z.classNameAliases[c[v]]||c[v],G=h[v];N?F(G,N):(C=G,Z(),C=""),v++}}function bt(c,h){return c.scope&&typeof c.scope=="string"&&D.openNode(z.classNameAliases[c.scope]||c.scope),c.beginScope&&(c.beginScope._wrap?(F(C,z.classNameAliases[c.beginScope._wrap]||c.beginScope._wrap),C=""):c.beginScope._multi&&(ft(c.beginScope,h),C="")),y=Object.create(c,{parent:{value:y}}),y}function yt(c,h,v){let E=Ce(c.endRe,v);if(E){if(c["on:end"]){const N=new e(c);c["on:end"](h,N),N.isMatchIgnored&&(E=!1)}if(E){for(;c.endsParent&&c.parent;)c=c.parent;return c}}if(c.endsWithParent)return yt(c.parent,h,v)}function fn(c){return y.matcher.regexIndex===0?(C+=c[0],1):(Qe=!0,0)}function bn(c){const h=c[0],v=c.rule,E=new e(v),N=[v.__beforeBegin,v["on:begin"]];for(const G of N)if(G&&(G(c,E),E.isMatchIgnored))return fn(h);return v.skip?C+=h:(v.excludeBegin&&(C+=h),j(),!v.returnBegin&&!v.excludeBegin&&(C=h)),bt(v,c),v.returnBegin?0:h.length}function yn(c){const h=c[0],v=m.substring(c.index),E=yt(y,c,v);if(!E)return pt;const N=y;y.endScope&&y.endScope._wrap?(j(),F(h,y.endScope._wrap)):y.endScope&&y.endScope._multi?(j(),ft(y.endScope,c)):N.skip?C+=h:(N.returnEnd||N.excludeEnd||(C+=h),j(),N.excludeEnd&&(C=h));do y.scope&&D.closeNode(),!y.skip&&!y.subLanguage&&(Ue+=y.relevance),y=y.parent;while(y!==E.parent);return E.starts&&bt(E.starts,c),N.returnEnd?0:h.length}function vn(){const c=[];for(let h=y;h!==z;h=h.parent)h.scope&&c.unshift(h.scope);c.forEach(h=>D.openNode(h))}let je={};function vt(c,h){const v=h&&h[0];if(C+=c,v==null)return j(),0;if(je.type==="begin"&&h.type==="end"&&je.index===h.index&&v===""){if(C+=m.slice(h.index,h.index+1),!R){const E=new Error(`0 width match regex (${r})`);throw E.languageName=r,E.badRule=je.rule,E}return 1}if(je=h,h.type==="begin")return bn(h);if(h.type==="illegal"&&!w){const E=new Error('Illegal lexeme "'+v+'" for mode "'+(y.scope||"<unnamed>")+'"');throw E.mode=y,E}else if(h.type==="end"){const E=yn(h);if(E!==pt)return E}if(h.type==="illegal"&&v==="")return C+=`
`,1;if(Je>1e5&&Je>h.index*3)throw new Error("potential infinite loop, way more iterations than matches");return C+=v,v.length}const z=Y(r);if(!z)throw se(T.replace("{}",r)),new Error('Unknown language: "'+r+'"');const wn=Qt(z);let Ze="",y=k||wn;const wt={},D=new d.__emitter(d);vn();let C="",Ue=0,ae=0,Je=0,Qe=!1;try{if(z.__emitTokens)z.__emitTokens(m,D);else{for(y.matcher.considerAll();;){Je++,Qe?Qe=!1:y.matcher.considerAll(),y.matcher.lastIndex=ae;const c=y.matcher.exec(m);if(!c)break;const h=m.substring(ae,c.index),v=vt(h,c);ae=c.index+v}vt(m.substring(ae))}return D.finalize(),Ze=D.toHTML(),{language:r,value:Ze,relevance:Ue,illegal:!1,_emitter:D,_top:y}}catch(c){if(c.message&&c.message.includes("Illegal"))return{language:r,value:We(m),illegal:!0,relevance:0,_illegalBy:{message:c.message,index:ae,context:m.slice(ae-100,ae+100),mode:c.mode,resultSoFar:Ze},_emitter:D};if(R)return{language:r,value:We(m),illegal:!1,relevance:0,errorRaised:c,_emitter:D,_top:y};throw c}}function Xe(r){const m={value:We(r),illegal:!1,relevance:0,_top:p,_emitter:new d.__emitter(d)};return m._emitter.addText(r),m}function Ke(r,m){m=m||d.languages||Object.keys(a);const w=Xe(r),k=m.filter(Y).filter(gt).map(j=>be(j,r,!1));k.unshift(w);const A=k.sort((j,F)=>{if(j.relevance!==F.relevance)return F.relevance-j.relevance;if(j.language&&F.language){if(Y(j.language).supersetOf===F.language)return 1;if(Y(F.language).supersetOf===j.language)return-1}return 0}),[B,Z]=A,Oe=B;return Oe.secondBest=Z,Oe}function an(r,m,w){const k=m&&o[m]||w;r.classList.add("hljs"),r.classList.add(`language-${k}`)}function Ye(r){let m=null;const w=P(r);if(g(w))return;if($e("before:highlightElement",{el:r,language:w}),r.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",r);return}if(r.children.length>0&&(d.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(r)),d.throwUnescapedHTML))throw new nn("One of your code blocks includes unescaped HTML.",r.innerHTML);m=r;const k=m.textContent,A=w?_(k,{language:w,ignoreIllegals:!0}):Ke(k);r.innerHTML=A.value,r.dataset.highlighted="yes",an(r,w,A.language),r.result={language:A.language,re:A.relevance,relevance:A.relevance},A.secondBest&&(r.secondBest={language:A.secondBest.language,relevance:A.secondBest.relevance}),$e("after:highlightElement",{el:r,result:A,text:k})}function rn(r){d=dt(d,r)}const on=()=>{Ne(),pe("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function ln(){Ne(),pe("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let ut=!1;function Ne(){function r(){Ne()}if(document.readyState==="loading"){ut||window.addEventListener("DOMContentLoaded",r,!1),ut=!0;return}document.querySelectorAll(d.cssSelector).forEach(Ye)}function cn(r,m){let w=null;try{w=m(t)}catch(k){if(se("Language definition for '{}' could not be registered.".replace("{}",r)),R)se(k);else throw k;w=p}w.name||(w.name=r),a[r]=w,w.rawDefinition=m.bind(null,t),w.aliases&&mt(w.aliases,{languageName:r})}function dn(r){delete a[r];for(const m of Object.keys(o))o[m]===r&&delete o[m]}function pn(){return Object.keys(a)}function Y(r){return r=(r||"").toLowerCase(),a[r]||a[o[r]]}function mt(r,{languageName:m}){typeof r=="string"&&(r=[r]),r.forEach(w=>{o[w.toLowerCase()]=m})}function gt(r){const m=Y(r);return m&&!m.disableAutodetect}function hn(r){r["before:highlightBlock"]&&!r["before:highlightElement"]&&(r["before:highlightElement"]=m=>{r["before:highlightBlock"](Object.assign({block:m.el},m))}),r["after:highlightBlock"]&&!r["after:highlightElement"]&&(r["after:highlightElement"]=m=>{r["after:highlightBlock"](Object.assign({block:m.el},m))})}function un(r){hn(r),b.push(r)}function mn(r){const m=b.indexOf(r);m!==-1&&b.splice(m,1)}function $e(r,m){const w=r;b.forEach(function(k){k[w]&&k[w](m)})}function gn(r){return pe("10.7.0","highlightBlock will be removed entirely in v12.0"),pe("10.7.0","Please use highlightElement now."),Ye(r)}Object.assign(t,{highlight:_,highlightAuto:Ke,highlightAll:Ne,highlightElement:Ye,highlightBlock:gn,configure:rn,initHighlighting:on,initHighlightingOnLoad:ln,registerLanguage:cn,unregisterLanguage:dn,listLanguages:pn,getLanguage:Y,registerAliases:mt,autoDetection:gt,inherit:dt,addPlugin:un,removePlugin:mn}),t.debugMode=function(){R=!1},t.safeMode=function(){R=!0},t.versionString=tn,t.regex={concat:H,lookahead:V,either:ke,optional:Se,anyNumberOfTimes:xe};for(const r in De)typeof De[r]=="object"&&s(De[r]);return Object.assign(t,De),t},he=ht({});return he.newInstance=()=>ht({}),nt=he,he.HighlightJS=he,he.default=he,nt}var oi=ri();const Lt=Tn(oi),St="[A-Za-z$_][0-9A-Za-z$_]*",li=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],ci=["true","false","null","undefined","NaN","Infinity"],At=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Pt=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],It=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],di=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],pi=[].concat(It,At,Pt);function hi(s){const e=s.regex,n=(I,{after:K})=>{const ie="</"+I[0].slice(1);return I.input.indexOf(ie,K)!==-1},i=St,l={begin:"<>",end:"</>"},f=/<[A-Za-z0-9\\._:-]+\s*\/>/,x={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(I,K)=>{const ie=I[0].length+I.index,de=I.input[ie];if(de==="<"||de===","){K.ignoreMatch();return}de===">"&&(n(I,{after:ie})||K.ignoreMatch());let fe;const Ie=I.input.substring(ie);if(fe=Ie.match(/^\s*=/)){K.ignoreMatch();return}if((fe=Ie.match(/^\s+extends\s+/))&&fe.index===0){K.ignoreMatch();return}}},U={$pattern:St,keyword:li,literal:ci,built_in:pi,"variable.language":di},ge="[0-9](_?[0-9])*",W=`\\.(${ge})`,we="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",X={className:"number",variants:[{begin:`(\\b(${we})((${W})|\\.)?|(${W}))[eE][+-]?(${ge})\\b`},{begin:`\\b(${we})\\b((${W})\\b|\\.)?|(${W})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},V={className:"subst",begin:"\\$\\{",end:"\\}",keywords:U,contains:[]},xe={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[s.BACKSLASH_ESCAPE,V],subLanguage:"xml"}},Se={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[s.BACKSLASH_ESCAPE,V],subLanguage:"css"}},H={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[s.BACKSLASH_ESCAPE,V],subLanguage:"graphql"}},Ee={className:"string",begin:"`",end:"`",contains:[s.BACKSLASH_ESCAPE,V]},le={className:"comment",variants:[s.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:i+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),s.C_BLOCK_COMMENT_MODE,s.C_LINE_COMMENT_MODE]},Ce=[s.APOS_STRING_MODE,s.QUOTE_STRING_MODE,xe,Se,H,Ee,{match:/\$\d+/},X];V.contains=Ce.concat({begin:/\{/,end:/\}/,keywords:U,contains:["self"].concat(Ce)});const Re=[].concat(le,V.contains),ee=Re.concat([{begin:/(\s*)\(/,end:/\)/,keywords:U,contains:["self"].concat(Re)}]),te={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:U,contains:ee},Te={variants:[{match:[/class/,/\s+/,i,/\s+/,/extends/,/\s+/,e.concat(i,"(",e.concat(/\./,i),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,i],scope:{1:"keyword",3:"title.class"}}]},ce={relevance:0,match:e.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...At,...Pt]}},_e={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},Le={variants:[{match:[/function/,/\s+/,i,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[te],illegal:/%/},Ae={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function ze(I){return e.concat("(?!",I.join("|"),")")}const qe={match:e.concat(/\b/,ze([...It,"super","import"].map(I=>`${I}\\s*\\(`)),i,e.lookahead(/\s*\(/)),className:"title.function",relevance:0},ne={begin:e.concat(/\./,e.lookahead(e.concat(i,/(?![0-9A-Za-z$_(])/))),end:i,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},Ve={match:[/get|set/,/\s+/,i,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},te]},Pe="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+s.UNDERSCORE_IDENT_RE+")\\s*=>",Ge={match:[/const|var|let/,/\s+/,i,/\s*/,/=\s*/,/(async\s*)?/,e.lookahead(Pe)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[te]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:U,exports:{PARAMS_CONTAINS:ee,CLASS_REFERENCE:ce},illegal:/#(?![$_A-z])/,contains:[s.SHEBANG({label:"shebang",binary:"node",relevance:5}),_e,s.APOS_STRING_MODE,s.QUOTE_STRING_MODE,xe,Se,H,Ee,le,{match:/\$\d+/},X,ce,{scope:"attr",match:i+e.lookahead(":"),relevance:0},Ge,{begin:"("+s.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[le,s.REGEXP_MODE,{className:"function",begin:Pe,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:s.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:U,contains:ee}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:l.begin,end:l.end},{match:f},{begin:x.begin,"on:begin":x.isTrulyOpeningTag,end:x.end}],subLanguage:"xml",contains:[{begin:x.begin,end:x.end,skip:!0,contains:["self"]}]}]},Le,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+s.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[te,s.inherit(s.TITLE_MODE,{begin:i,className:"title.function"})]},{match:/\.\.\./,relevance:0},ne,{match:"\\$"+i,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[te]},qe,Ae,Te,Ve,{match:/\$[(.]/}]}}Lt.registerLanguage("javascript",hi);class ui extends M{static styles=[Q(ai)];static properties={language:{type:String},code:{tyoe:String,state:!0}};constructor(){super(),this.language="javascript"}#t(){const n=this.shadowRoot.querySelector("slot").assignedNodes()[0].textContent;this.code=Lt.highlight(n,{language:this.language}).value}render(){return u`
      <pre part="container"><code>${Et(this.code)}</code></pre>
      <slot @slotchange="${()=>this.#t()}"></slot>
    `}}customElements.define("code-block",ui);const mi="::slotted([slot=demo]){aspect-ratio:var(--ratio-widescreen)}::slotted([slot=description]){padding-left:var(--size-2);color:var(--color-4);font-weight:var(--font-weight-3);font-size:var(--font-size-1);text-align:justify;border-left:3px solid var(--color-5)}::slotted([slot=toggle-collapsed]),::slotted([slot=toggle-expanded]){display:flex;gap:var(--size-1);align-items:center;cursor:pointer}[part=implementation]{display:none;margin-bottom:var(--size-4);background-color:var(--color-10);border:2px solid var(--color-5);border-radius:var(--radius-1);box-shadow:var(--inner-shadow-4)}[part=implementation].active{display:block}[part=implementation-code]{padding-inline:var(--size-3)}[part=implementation-footer]{display:flex;align-items:center;justify-content:end;border-top:1px solid var(--color-6);padding-inline:var(--size-2)}[part=implementation-link]{padding:var(--size-2);font-size:var(--font-size-0)}[part=implementation-toggle]{background:none;border:none}[part=implementation-toggle]:hover{background:none}";class gi extends M{static styles=[Fe,st,Q(mi)];static properties={collapsed:{type:Boolean},hasCodeExample:{type:Boolean,state:!0},exampleLanguage:{type:String},href:{type:String}};connectedCallback(){super.connectedCallback(),this.collapsed=!0,this.shadowRoot.addEventListener("slotchange",()=>{this.hasCodeExample=this.#t("code")})}updated(e){super.updated(e),e.has("collapsed")&&!this.collapsed&&this.shadowRoot.querySelector('[part="implementation"]').classList.add("active")}#t(e){return this.shadowRoot.querySelector(`slot[name="${e}"]`).assignedNodes().length>0}#e(e){e.target.classList.toggle("active",!e.target.classList.contains("fade-out-shrink")),e.target.classList.remove("fade-in-grow","fade-out-shrink")}#n(){return{"fade-in-grow":this.collapsed===!1,"fade-out-shrink":this.collapsed===!0}}render(){return u`
...
`;function Ai(s){const e=s.replace(/^[\r\n]+|[\r\n]+$/g,""),i=e.split(`
`)[0].match(/^ */)[0].length,l=new RegExp(`^ {${i}}`,"gm");return e.replace(l,"")}const Pi=new DOMParser;function O(s,e="[data-implementation]"){return Ai(Pi.parseFromString(s,"text/html").querySelector(e).textContent)}const Ii=[{id:"start-time",href:"start-time.html",title:"Start the player at a given position",description:u`In this showcase, we'll demonstrate how to load a video source and start playback at a specific position using Pillarbox. This can be useful when you want to provide users with the option to begin watching a video from a predefined timestamp. To achieve this functionality, follow the code snippet below:`,code:O(fi)},{id:"multi-player",href:"multi-player.html",title:"Multiple Players",description:u`This example demonstrates how to incorporate multiple video players on a webpage.In this showcase, two players are initialized, each with its own configuration, a button allows to toggle the mute state for both players.`,code:O(bi)},{id:"blocked-segments",href:"blocked-segment.html",title:"Detect Blocked Segments",description:u`This tutorial covers how to use Pillarbox to create a plugin that detects and notifies when a blocked segment is skipped. <br><br><b>Note:</b> The blocked segment starts at 29:26 for this example.`,code:O(yi)},{id:"chapters",href:"chapters.html",title:"Display Current Chapter",description:u`This showcase explains how to use Pillarbox to create a plugin that displays the currently playing chapter in a box above the progress bar.`,code:O(vi)},{id:"skip-credits",href:"skip-credits.html",title:"Skip Credits",description:u`This example shows how to use the <a href="https://github.com/SRGSSR/pillarbox-web-suite/tree/main/packages/skip-button#readme" target="_blank">Pillarbox Skip Button component</a> to add a "Skip" button during detected credit intervals. <br><br><b>Note:</b> Seek to 26:40 to see the button.`,code:O(wi)},{id:"playlist",href:"playlist.html",title:"Playlist",description:u`This example shows how to fetch media data for a set of video sources and load them into the <a href="https://github.com/SRGSSR/pillarbox-web-suite/tree/main/packages/pillarbox-playlist#readme" target="_blank">Pillarbox Playlist plugin</a> with metadata such as title and duration.`,code:O(xi)},{id:"quality-menu",href:"quality-menu.html",title:"Quality Menu",description:u`In this showcase, we'll demonstrate how to display a quality selector menu using the <a href="https://github.com/videojs/videojs-contrib-quality-menu" target="_blank">videojs-contrib-quality-menu</a> plugin.`,code:O(Si)},{id:"countdown",href:"countdown.html",title:"Countdown Timer",description:u`In this showcase, we'll demonstrate how to display a countdown timer.`,code:O(Ei)},{id:"playback-rate",href:"playback-rate.html",title:"Playback Rate",description:u`In this showcase, we'll demonstrate how to display the playback rate component.`,code:O(ki)},{id:"chapter-selection",href:"chapter-selection.html",title:"Chapter Selection",description:u`In this showcase, we'll demonstrate how to display a chapter selector.`,code:O(Ci)},{id:"firefox-pip",href:"firefox-pip.html",title:"Hide Firefox PiP Button",description:u`In this showcase, we'll demonstrate how to hide Firefox PiP Button. Activating or deactivating PiP in Firefox applies at the next player resize, such as when entering full screen mode. This appears to be due to an implementation bug in Firefox. Refer to the <a href="https://github.com/SRGSSR/pillarbox-web-demo/pull/57" target="_blank">PR</a> for more details.`,code:O(Ri)},{id:"spatial-navigation",href:"spatial-navigation.html",title:"Enable Spatial Navigation",description:u`In this showcase, we will demonstrate how to enable <a href="https://videojs.com/guides/spatial-navigation/" target="_blank" rel="noopener noreferrer">spatial navigation</a>, allowing users to control the player with a remote on smart TVs like Tizen and webOS.<br><br>            <i>Note: If you're targeting TV devices with spatial navigation, consider removing the volume button and setting muted: false, as volume is typically handled by the device itself.</i>`,code:O(Ti)},{id:"thumbnail-preview",href:"thumbnail-preview.html",title:"Thumbnail Preview",description:u`This example shows how to use the thumbnail preview metadata from the current SRGSSR source and inject it into the <a href="https://github.com/SRGSSR/pillarbox-web-suite/tree/main/packages/thumbnail-preview#readme" target="_blank">Thumbnail Preview plugin</a>.`,code:O(_i)},{id:"toggle-live-audio-video",href:"toggle-live-audio-video.html",title:"Toggle between an audio and a video live stream",description:u`This example shows how to switch between the audio and video streams of the same channel.`,code:O(Li)}];class Di extends M{createRenderRoot(){return this}render(){return u`
      <div class="fade-in"
           @animationend="${e=>e.target.classList.remove("fade-in")}">
        ${oe(Ii??[],this.#t.bind(this))}
      </div>
    ...
    `}}customElements.define("showcase-page",Di);S.addRoute("showcase","showcase-page");class Mi extends M{static properties={debug:{type:Boolean,state:!0}};createRenderRoot(){return this}#t=({detail:{queryParams:e}})=>{this.debug=e.debug==="true"};connectedCallback(){super.connectedCallback(),this.debug=S.queryParams.debug==="true",S.addEventListener("routechanged",this.#t),S.addEventListener("queryparams",this.#t)}disconnectedCallback(){S.removeEventListener("routechanged",this.#t),S.removeEventListener("queryparams",this.#t)}render(){return u`
      ${this.#e()}
      ${this.#n()}
    `}#e(){return u`
      <core-demo-header>
    ...
    `}#n(){return u`
      ...
      </nav>`}}customElements.define("demo-header",Mi);class Ni extends M{static properties={route:{state:!0}};constructor(){super(),this.route=S.currentRoute,S.addEventListener("routechanged",({detail:{route:e}})=>{this.route?.destroy(),this.route=e})}createRenderRoot(){return this}render(){return Et(`<${this.route.component}></${this.route.component}>`)}}customElements.define("route-outlet",Ni);const Be=ue.loadPreferences();$.host=Be.dataProviderHost;S.start({defaultPath:"examples"});S.queryParams.debug?(Be.debug=S.queryParams.debug==="true",ue.savePreferences(Be)):Be.debug&&S.updateState({debug:"true"});
//# sourceMappingURL=index-dCulofZK.js.map
